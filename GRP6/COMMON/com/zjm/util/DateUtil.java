...
public class DateUtil {
     ...
     * 时间格式：yyyy-MM-dd HH.
     */
    public static final String DATETIME_PATTERN_NO_MIN = "yyyy-MM-dd HH";
     ...
     * @param format
     * @return String
     * @description 获取 指定时间前几小时的时间
     * @since 1.0.0
     */
    public static String frontHours(Date d, int hours, String format) {
        //当前时间
        Calendar cal = Calendar.getInstance();
        cal.setTime(d);
...
//    }
    ...
    public static Date dateAddMins(Date date, int minCnt) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(date);
        cal.setTimeInMillis(cal.getTimeInMillis()+minCnt);
        return cal.getTime();
    }
