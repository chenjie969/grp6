...
<div class="modal fade" id="addDownClient" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">新增下游销售客户</h4>
      </div>
      <div class="modal-body">
      	 <form class="form-horizontal row" role="form" id="add_downClient_form">
      	 	<input type="hidden" name="upDownFlag" value="02">
			...
			<div class="form-group col-xs-12">
				...
				<div class="col-sm-9 col-xs-12">
					<div class="row">
					    <div class="col-xs-10">
							<input type="text" name="contractPeriod" class="col-sm-12 validate[required,maxSize[25]]"/>
						</div>
			        </div>
				</div>
			</div>
			...
			<div class="form-group col-xs-12">
				...
				<div class="col-sm-9 col-xs-12">
					<div class="row">
					    <div class="col-xs-10">
							<textarea class="col-xs-12 validate[maxSize[100]]"   name="productName" rows="5"></textarea>
			...
			<div class="form-group col-xs-12">
				...
				<div class="col-sm-9 col-xs-12">
					<div class="row">
					    <div class="col-xs-10">
							<input type="text" name="currentSum" class="col-xs-8 validate[required,maxSize[18],custom[number]]"/>
