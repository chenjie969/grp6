...
public class ResultDescriptor extends AbstractDescriptor implements Validatable {
    ...
    public void writeXML(PrintWriter out, int indent) {
        ...
        if (join != 0) {
            ...
            //zhongzk
            if ((owner_type != null) && (owner_type.length() > 0)) {
                buf.append(" owner_type=\"").append(owner_type).append("\"");
            }
    ...
    protected void init(Element result) {
        ...
        //zhongzk
        owner_type=result.getAttribute("owner_type");
