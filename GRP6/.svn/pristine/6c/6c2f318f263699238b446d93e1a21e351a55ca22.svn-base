				...
				<div id="divTwo">	<!-- divTwo 开始-->
						...
						<form class="form-horizontal" role="form" id="form_baseTwo">
                              ...
                              <div class="form-group col-sm-6">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" id="count" placeholder="" name="count" class="col-sm-6 validate[custom[number],maxSize[6]]" />
                                  </div>
                              </div>
...
<%@ include file="/common_timestamp.jsp" %>
	<script src="<%=path%>/project/opt/optManager/ZYinventoryPledge.js?v=<%=vardate%>"></script>
