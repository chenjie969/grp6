...
public interface WorkflowStore {
     ...
     */
    //������ǰ����
    //zhongzk fixed ����StepName����
    public Step createCurrentStep(long entryId, int stepId,String stepName, String owner, Date startDate, Date dueDate, String status, long[] previousIds) throws StoreException;
