...
$(function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            $("#managerNameList").selectTreeWidgets({
                width: "93%",//设置控件宽度
                multiple: true,//是否多选
                data: data.obj//数据源
            });
    ...
    $("#meeting_room_add").validationEngine();
    $("#meeting_room_add").on("submit", function () {
        var $form = $("#meeting_room_add");
                ...
                success: function (result) {
                    if (result.obj === 1) {
                        ...
                        $('#pleaseSelectOne').on('hidden.bs.modal', function (e) {
                            window.parent.closeMenu("meetingRoomAdd");
                        })
                    } else {
