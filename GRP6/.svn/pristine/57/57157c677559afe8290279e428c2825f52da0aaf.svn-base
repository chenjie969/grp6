...
<div class="modal fade bs-example-modal-sm" id="addXPersonClientModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		<form class="form-horizontal" role="form" id="add_xPersonClientForm">
			<input type="hidden" name="clientTypeID" class="ztb_add_clientTypeID" value="03"><%--'01企业02个人经营类03个人消费类（不做字典，直接写在程序中）' --%>
