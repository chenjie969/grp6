...
<div class="modal fade bs-example-modal-sm" id="updatetransferModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static"
	data-keyboard="false">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">岗位变动</h4>
			</div>
			<div class="modal-body">
				<form class="form-horizontal" role="form" id=updatetransfer_Form>
				 <input type="hidden" id="postsID" name="postsID" value="${hrstaffPosts.postsID}"/>
			...
			<div class="form-group ">
						...
						<div class="col-sm-9">
							<div class="col-md-6 col-sm-6 input-group allDepartsTree1">
								<input type="text" class="form-control " autoField="agoPostsDep" id="allDepartsTree1" value="${hrstaffPosts.agoPostsDepNmae}"
					...
					<div class="form-group ">
						...
						<div class="col-sm-9">
							<div class="col-md-6 col-sm-6 input-group allDepartsTree2">
								<input type="text" class="form-control" autoField="nowPostsDep" id="allDepartsTree2" value="${hrstaffPosts.nowPostsDepName}" name="departName2"
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group col-sm-10" style="float: left;">
								<input class="form-control date-picker validate[custom[date]]" type="text" id="date-picker-1"  name="changePostsDate" 
										value="<fmt:formatDate value='${hrstaffPosts.changePostsDate}' pattern='yyyy-MM-dd' type='date'/>"/>
