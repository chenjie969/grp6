...
<div class="modal fade" id="editOneProductModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">修改产品流程</h4>
      </div>
      <div class="modal-body">
      	 <form class="form-horizontal row" role="form" id="edit_productForm">
			...
			<div class="form-group col-xs-12">
				...
				<div class="col-sm-8 col-xs-12">
					<div class="row">
					    <div class="col-xs-10">
							<input type="text" name="productName" id="edit_ProductName" class="col-xs-12 validate[required,maxSize[50]]" value="${product.productName}"/>
						</div>
			        </div>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<div class="row">
					    <div class="col-xs-10">
					    	<input type="hidden" id="productTypeName"  name="productTypeName" value="${product.productTypeName}">
