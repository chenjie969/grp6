			...
			<div class="col-xs-12">
                <div class="tabbable">
        			<div class="page-header">
        				<button class="btn btn-sm btn-info" id="btn_openProjectLawsuit" >诉讼登记</button>
						<button class="btn btn-sm btn-info" id="btn_refresh" >重置列表</button>
					</div>
                  	<ul class="nav nav-tabs" id="myTab">
                       <li class="active">
                           <a data-toggle="tab" href="#ok" id="suit1List">
                               	主诉列表
                           </a>
                       </li>

                       <li>
                           <a data-toggle="tab" href="#no" id="suit2List">
                            	被诉列表
                           </a>
                       </li>
                  	</ul>
        			<div class="tab-content">
	                      <div id="ok" class="tab-pane in active">
								<div class="table-responsive"  id="loadinfo">
									 <table id="suit1-table" style="font-size:13px !important;"></table>  
			                    </div>
				          </div>
	                      ...
	                      <div id="no" class="tab-pane">
								<div class="table-responsive"  id="loadinfo">
									 <table id="suit2-table" style="font-size:13px !important;"></table>  
			                    </div>
	                      </div>
                  </div>
              </div>
