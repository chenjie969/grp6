				...
				<input type="hidden" id="lastTableDictypeID">	
					<div class="page-content">
						...
						<div class="page-header">
							<button type="button" name="button" class="btn btn-sm btn-info" id="btn_add" >添加下级业务品种</button>
                                    ...
                                    <div class="col-sm-3">
										...
										<div class="widget-box">
                                            <div class="widget-header">
                                                <h4 class="lighter smaller">业务品种设置</h4>
                                            </div>
...
<%-- 	<script src="<%=path %>/sys/modules/index.js?v=<%=vardate%>"></script> --%>
		<script src="<%=path %>/sys/dataBaseVindicate/busiSort/index.js?v=<%=vardate%>"></script>


	
	<%@ include file="/sys/dataBaseVindicate/busiSort/add.jsp" %>
	<%@ include file="/sys/dataBaseVindicate/busiSort/edit.jsp" %>
	<%@ include file="/sys/dataBaseVindicate/busiSort/view.jsp" %>
	<%@ include file="/sys/dataBaseVindicate/busiSort/del.jsp" %>
	<%@ include file="/sys/dataBaseVindicate/busiSort/isDefaultDel.jsp"%>
	<%@ include file="/sys/dataBaseVindicate/busiSort/failDel.jsp"%>
