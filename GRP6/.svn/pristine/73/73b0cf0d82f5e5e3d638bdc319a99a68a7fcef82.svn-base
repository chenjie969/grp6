...
%>
 <div class="modal fade" id="reportSelect_endDate" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"  data-backdrop="static" data-keyboard="false">
             ...
             <form class="form-horizontal" role="form" id="reportSelect_form_endDate">
