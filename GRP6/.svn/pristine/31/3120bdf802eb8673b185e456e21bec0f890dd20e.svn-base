				...
				<div id="divTwo">	<!-- divTwo 开始-->
						...
						<form class="form-horizontal" role="form" id="form_baseTwo">
							 ...
							 <div class="form-group col-sm-6">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" id="billNumber" name="billNumber" class="col-sm-6 validate[maxSize[50]]" />
                                  </div>
                              </div>
                              ...
                              <div class="form-group col-sm-6">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" id="billCode" name="billCode" class="col-sm-6 validate[maxSize[50]]" />
                                  </div>
                              </div>
                               ...
                               <div class="form-group col-sm-6">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" id="adderss" name="adderss" class="col-sm-6 validate[maxSize[50]]" />
                                  </div>
                              </div>
                              ...
                              <div class="form-group col-sm-6">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" id="payPerson" name="payPerson" class="col-sm-6 validate[maxSize[50]]" />
                                  </div>
                              </div>
                              ...
                              <div class="form-group col-sm-6">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" id="leaseCode" name="leaseCode" class="col-sm-6 validate[maxSize[50]]" />
                               ...
                               <div class="form-group col-sm-6">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" id="carFrame" name="carFrame" class="col-sm-6 validate[maxSize[50]]" />
                                  </div>
                              </div>
                              ...
                              <div class="form-group col-sm-6">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" id="firstOwner" name="firstOwner" class="col-sm-6 validate[maxSize[50]]" />
                                  </div>
                              </div>
                               ...
                               <div class="form-group col-sm-6">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" id="firstOwnerCode" name="firstOwnerCode" class="col-sm-6 validate[maxSize[50]]" />
                                  </div>
                              </div>
                              ...
                              <div class="form-group col-sm-6">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" id="secondOwner" name="secondOwner" class="col-sm-6 validate[maxSize[50]]" />
                                  </div>
                              </div>
                               ...
                               <div class="form-group col-sm-6">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" id="secondOwnerCode" name="secondOwnerCode" class="col-sm-6 validate[maxSize[50]]" />
                                  </div>
                              </div>
...
<script src="<%=path%>/project/opt/optManager/ZYarticlePledge.js?v=<%=vardate%>"></script>
