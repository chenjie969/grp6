...
<div class="modal fade bs-example-modal-sm" id="returnDetailAdd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		<form class="form-horizontal" role="form" id="add_returnDetailForm">
						...
						<div class="row">
							<div class="col-sm-8">
								<div class="input-group">
									...
									name="returnDate" id="id-date-picker-1"  data-date-format="yyyy-mm-dd" />
				...
				<div class="col-sm-8">
						<div class="row">
							<div class="col-sm-8">
								<div class="input-group">
									<input  type="text" class="form-control date-picker validate[required,custom[date]]" 
									name="returnFactDate" id="id-date-picker-2"  data-date-format="yyyy-mm-dd" />
									<span class="input-group-addon">
										<i class="icon-calendar bigger-110"></i>
									</span>
								</div>
