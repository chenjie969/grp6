                           ...
                           <div id="isHaveOtherDIV">
                        	...
                        	<div  id="isProxyDIV">
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-10">
                                      <input type="text" id="houseAddress" placeholder="" name="houseAddress" value="${opt.houseAddress }" class="col-sm-5 validate[maxSize[200]]" /><!-- validate[required,maxSize[200]]  -->
                                  </div>
                              </div>
                              ...
                              <div class="form-group col-sm-6">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" id="certificateNum" name="certificateNum" value="${opt.certificateNum }"  class="col-sm-6 validate[required,maxSize[50]]" />
                                  </div>
                              </div>
							  ...
							  <div class="form-group col-sm-6">
                                  ...
                                  <div class="col-sm-8">					
                                      <input type="text" id="houseArea" name="houseArea" value="<fmt:formatNumber value="${opt.houseArea }" pattern="####.##"/>"  class="col-sm-4 validate[custom[number],maxSize[18]]" /><!--  validate[required,custom[number],maxSize[18]] -->
                              ...
                              <%-- <div class="form-group col-sm-6">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" id="pledgePart" name="pledgePart" value="${opt.pledgePart }" class="col-sm-6 validate[required,maxSize[50]]" />
                                  </div>
							  ...
							  <div class="form-group col-sm-6">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" id="havingArea" placeholder="" value="<fmt:formatNumber value="${opt.havingArea }" pattern="####.##"/>"  name="havingArea" class="col-sm-4 validate[required,custom[number],maxSize[18]]" />
                                      <span style="line-height:28px;">&nbsp;平方米</span>
                                  </div>
                              </div>
