		...
		<div class="col-xs-12">
			<form class="form-horizontal" role="form">
                 <div class="form-group col-sm-6">
                  ...
                  <div class="form-group col-sm-6">
                      <label class="col-sm-4 control-label no-padding-right">主体名称： </label>
                      <label class="col-sm-8 grey">
                        	  ${applyDetail.relationName}
                      </label>
                  </div>
                ...
                <%--   <div class="form-group">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-12" >
                          <table style="font-size:13px;text-align:center;" id="no"   data-toggle="table"  data-striped="true">
                              <thead>
                                <tr >
                                    <th>项目类型</th>
                                    <!-- <th>客户名称</th> -->
