...
<style>
					...
					<c:if test="${opt.relieveFlag eq '01' || opt.relieveFlag eq '02'}">
						...
						<form class="form-horizontal" role="form" id="form_baseTwo">
                            ...
                            <div class="col-sm-offset-1 col-sm-10">
								...
								<h5 class="col-sm-6" style="line-height:26px;">法定代表人：<span class="grey">${opt.otherLegalPerson }</span></h5>
								<h5 class="col-sm-6" style="line-height:26px;">法人联系方式：<span class="grey">${opt.otherLegalPhone }</span></h5>
								<h5 class="col-sm-12" style="line-height:26px;">住所：<span class="grey">${opt.otherLegalAddress }</span></h5>
								<h5 class="col-sm-6" style="line-height:26px;">邮编：<span class="grey">${opt.otherPostCode }</span></h5>
								<h5 class="col-sm-6" style="line-height:26px;">传真：<span class="grey">${opt.otherFax }</span></h5>
                        	...
                        	<div  id="isProxyDIV">
                        		 ...
                        		 <h5 class="col-sm-12" style="line-height:26px;">银行账号：<span class="grey">${opt.bankNumber }</span></h5>
                 				...
                 				<h5 class="col-sm-12" style="line-height:26px;">企业曾用名：<span class="grey">${opt.companyOnceName }</span></h5>
	...
	<script src="<%=path%>/project/opt/optManager/enterpriseCreditView.js?v=<%=vardate%>"></script>
