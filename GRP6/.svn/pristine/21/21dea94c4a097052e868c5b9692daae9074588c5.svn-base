...
<style>
				...
				<div id="divTwo">	<!-- divTwo 开始-->
					...
					<div class="col-sm-offset-1 col-sm-10">
							 ...
							 <c:if test="${opt.clientTypeID ne '01' }">   	
								...
								<h5 class="col-sm-6" style="line-height:26px;">上市地点：<span class="grey">${opt.ipoSite }</span></h5>
								<h5 class="col-sm-6" style="line-height:26px;">上市公司名称：<span class="grey">${opt.ipoName }</span></h5>
								<h5 class="col-sm-6" style="line-height:26px;">股票代码：<span class="grey">${opt.stockCode }</span></h5>
								<h5 class="col-sm-6" style="line-height:26px;">持股数量：<span class="grey">
									<fmt:formatNumber value="${opt.stockCount }" pattern="###,###"/>股</span></h5>
	...
	<script src="<%=path%>/project/opt/optManager/ZYstockPledgeView.js?v=<%=vardate%>"></script>
