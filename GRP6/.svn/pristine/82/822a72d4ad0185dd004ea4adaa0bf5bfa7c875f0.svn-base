      ...
      <div class="row">
		...
		<form class="form-horizontal" role="form" id="projectOverRgister_form">
           ...
           <div class="form-group">
	             ...
	             <div class="col-md-10">
	                 <input type="text" class="col-md-2 col-lg-1 validate[required,maxSize[18],custom[number]]"  id="overSum" name="overSum"  readonly="readonly" value="<fmt:formatNumber value="${project.guarantySum}" pattern="###.######"/>" />
           ...
           <div class="form-group">
			...
			<div class="form-group">
	         	...
	         	<div class="col-md-6">
					<div class="input-group col-md-6">
						<input class="form-control date-picker validate[required,custom[date]]" id="overDate" name="overDate" type="text" data-date-format="yyyy-mm-dd"  value="<fmt:formatDate value="${project.overDate}" type="time" timeStyle="full" pattern="yyyy-MM-dd"/>"/>
			...
			<div class="form-group">
	         	...
	         	<div class="col-md-6">
					<div class="input-group col-md-6">
						<input class="form-control date-picker validate[required,custom[date]]" id="overFactDate" name="overFactDate" type="text" data-date-format="yyyy-mm-dd"  value="<fmt:formatDate value="${project.overFactDate}" type="time" timeStyle="full" pattern="yyyy-MM-dd"/>"/>
						<span class="input-group-addon">
							<i class="icon-calendar bigger-110"></i>
						</span>
					</div>
           ...
           <div class="form-group">
	             ...
	             <div class="col-md-10">
	                 <textarea class="col-sm-7 limited  validate[maxSize[2000]]" rows="5"  name="overDesc" id="overDesc" >${project.overDesc}</textarea>											
