			...
			{field:'projectName',title:'项目名称',align:'center',formatter: function (value, row, index) {
				...
				events:{
					'click .btn_project_edit': function(e, value, row, index) {
						$.zjm_costProject.editModule(row);
					},
				}
			},
//			{field:'loadSum',title:'业务品种',align:'center',formatter: function (value, row, index) {return row.loadSum;}},
			{field:'bankName',title:'费用金额',align:'center',formatter: function (value, row, index) {return row.loadSum*0.05;}},
			{field:'loadBeginDate',title:'收费日期',align:'center',formatter: function (value, row, index) {return '2017-09-03';}},
		...
		$.zjm_costProject.initProjectTalble(columns);
...
$(function () {
	...
	$("#btn_deleteOfSelected").click(function(){
		$.zjm_costProject.deleteOfSelected();
	});
