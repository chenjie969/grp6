...
//			{field:'loadSum',title:'业务品种',align:'center',formatter: function (value, row, index) {return row.loadSum;}},
			...
			{field:'fundChinese',title:'资金方',align:'center',formatter: function (value, row, index) {return row.fundChinese;}},
...
//			{field:'guarantySum',title:'在保余额（万元）',align:'center',formatter: function (value, row, index) {return row.guarantySum;}},
			{field:'paySum',title:'还款金额（万元）',align:'center',formatter: function (value, row, index) {return row.paySum;}},
			{field:'payCapitalSum',title:'还款本金（万元）',align:'center',formatter: function (value, row, index) {return row.payCapitalSum;}},
			{field:'payInterestSum',title:'还款利息（万元）',align:'center',formatter: function (value, row, index) {return row.payInterestSum;}},
		...
		$('#project-table').bootstrapTable({
			...
			detailFormatter:function(index, row){
			    var html = [];
			        ...
			        html.push('<p><b>担保本金（万元）:</b> ' + tool.isNull(row.position,"") + '</p>');
			        html.push('<p><b>担保利息（万元）:</b> ' + tool.isNull(row.position,"") + '</p>');
			...
			queryParams: function(params) {
				$.extend(params,{"wheresql":" and YEAR(payDate) = YEAR(NOW()) "});
				return params;
