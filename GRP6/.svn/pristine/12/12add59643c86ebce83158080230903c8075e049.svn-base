...
<div class="modal fade" id="editLoanRec" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">修改贷款银行</h4>
      </div>
      <div class="modal-body">
      	 <form class="form-horizontal row" role="form" id="edit_loanRec_form">
      	 	<input type="hidden" name="loanRec_ID" value="${loanRec.loanRec_ID }">
			<div class="form-group col-xs-12">
				...
				<div class="col-sm-9 col-xs-12">
					<div class="row">
					    <div class="col-xs-11">
							<input type="text" name="loanBank" class="col-sm-12 validate[required,maxSize[25]]" value="${loanRec.loanBank }"/>
						</div>
			        </div>
				</div>
			</div>
			<div class="form-group col-xs-12">
				...
				<div class="col-sm-9 col-xs-12">
					<div class="row">
					    <div class="col-xs-11">
							<input type="text" name="loanSum" class="col-xs-6 validate[required,maxSize[18],custom[number]]" value="${loanRec.loanSum }"/>
			...
			<div class="form-group col-xs-12">
				...
				<div class="col-sm-9 col-xs-12">
					<div class="row">
					    <div class="col-xs-11">
							<input type="text" name="period" class="col-sm-12 validate[required,maxSize[25]]" value="${loanRec.period }"/>
						</div>
			        </div>
				</div>
			</div>
						...
						<div class="col-xs-5 no-padding-right">
							<div class="input-group">
								<input class="form-control date-picker validate[required,custom[date]]" type="text" data-date-format="yyyy-mm-dd" name="beginDate"  
									value="<fmt:formatDate value='${loanRec.beginDate }' pattern='yyyy-MM-dd'/>">
						...
						<div class="col-xs-5 no-padding-left">
							<div class="input-group">
								<input class="form-control date-picker validate[required,custom[date]]" type="text" data-date-format="yyyy-mm-dd" name="endDate" 
									value="<fmt:formatDate value='${loanRec.endDate }' pattern='yyyy-MM-dd'/>">
								<span class="input-group-addon">
									<i class="icon-calendar bigger-110"></i>
								</span>
							</div>
			...
			<div class="form-group col-xs-12">
				...
				<div class="col-sm-9 col-xs-12">
					<div class="row">
					    <div class="col-xs-11">
							<textarea class="col-xs-12 validate[maxSize[100]]" name="guarantyType" rows="5">${loanRec.guarantyType }</textarea>
			...
			<div class="form-group col-xs-12">
				...
				<div class="col-sm-9 col-xs-12">
					<div class="row">
					    <div class="col-xs-11">
							<textarea class="col-xs-12 validate[maxSize[100]]"   name="remark" rows="5">${loanRec.remark }</textarea>
							<div class="col-xs-12 no-padding-right">
								<span class="light-grey" style="float:right">限制100个字符</span>
							</div>
						</div>
