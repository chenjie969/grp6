...
<div class="modal fade" id="draftAnnounceView" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
      ...
      <div class="modal-body">
      	<div class="row">
			<div class="col-sm-offset-1 col-sm-10">
				...
				<c:if test="${message.approvalStatus=='03' }">
					<div class="col-sm-12">
						...
						<div class="tabbable">
							...
							<div class="tab-content" style="height:120px;">
								<div id="viewDetail" class="tab-pane in active">
									<div class="col-sm-12">
										<label class="row col-sm-12 control-label no-padding-right" for="form-input"><i class="icon-asterisk orange"></i>共<font  style="font-weight:bold;color:red;">${message.messageId}</font>人已查阅</label>
								...
								<div id="signDetail" class="tab-pane">
									<div class="col-sm-12">
										<label class="row col-sm-12 control-label no-padding-right" for="form-input"><i class="icon-asterisk orange"></i>共<font style="font-weight:bold;color:red;">5</font>人已签收</label>
									</div>
								</div>
								<div id="noSignDetail" class="tab-pane">
									<div class="col-sm-12">
										<label class="row col-sm-12 control-label no-padding-right" for="form-input"><i class="icon-asterisk orange"></i>共<font style="font-weight:bold;color:red;">1</font>人未签收</label>
										<label class="row col-sm-12 control-label no-padding-right" for="form-input"><i class="icon-asterisk orange"></i>市场部</label>
										<div class="row col-sm-12">
											超级管理员 &nbsp;&nbsp;&nbsp;&nbsp;张晓明
										</div>
									</div>
