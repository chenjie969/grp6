...
<div class="modal fade" id="enterpriseDepotAdQuery" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	 <form class="form-horizontal row" role="form" id="enterpriseDepot_advancedQuery_form">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
				    <div class="row">
					    <div class="col-sm-10">
							<input type="text" name="contact" class="col-sm-12 validate[maxSize[10]]">
						</div>
			        </div>
		    	</div>
			</div>
