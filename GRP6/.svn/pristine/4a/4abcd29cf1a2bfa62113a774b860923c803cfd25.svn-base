        ...
        <div class="col-xs-12"><!--begin 响应式列  -->
            ...
            <!-- <div class="col-sm-4 col-xs-8 pull-right" id="search_form">
                <div class="input-group">
                    <input class="form-control search-query" type="text" placeholder="请输入会议名称">
...
<%@ include file="/oa/meeting/rejectModal.jsp" %>
<script src="<%=path%>/oa/meeting/js/approval.js?v=<%=vardate%>"></script>
