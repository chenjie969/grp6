...
<div class="modal fade" id="viewEnterpriseApply" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">查看企业咨询情况</h4>
      </div>
      <div class="modal-body">
      	<div class="row">
			<div class="col-sm-offset-1 col-sm-10">
				...
				<div class="col-sm-6">
					<div class="row">
						<h5 class="col-sm-12">申请金额：<span class="grey" style="line-height:26px;">
							<fmt:formatNumber value="${apply.applySum }" pattern="###,###.######"/>万元</span></h5>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="row">
				...
				<div class="col-sm-12 col-xs-12">
					<div class="row">
						<h5 class="col-sm-12">客户来源：<span class="grey" style="line-height:26px;">${apply.clientSourceName }</span></h5>
					</div>
				</div>
				<div class="col-sm-12 col-xs-12">
					<div class="row">
