...
<style>
						...
						<c:if test="${opt.relieveFlag eq '01' || opt.relieveFlag eq '02'}">
                           ...
                           <div class="col-sm-offset-1 col-sm-10">
							 ...
							 <c:if test="${opt.clientTypeID ne '01' }">   	
                               ...
                               <h5 class="col-sm-6" style="line-height:26px;">乙方名称：<span class="grey">${opt.thirdOwnerName }</span></h5>
                               <h5 class="col-sm-6" style="line-height:26px;">统一社会信用代码：<span class="grey">${opt.thirdrCreditCode }</span></h5>
                               <h5 class="col-sm-6" style="line-height:26px;">法定代表人：<span class="grey">${opt.thirdLegalPerson }</span></h5>
                               <h5 class="col-sm-6" style="line-height:26px;">法人联系方式：<span class="grey">${opt.thirdLegalPhone }</span></h5>
                               <h5 class="col-sm-6" style="line-height:26px;">住所：<span class="grey">${opt.thirdLegalAddress }</span></h5>
                               <h5 class="col-sm-6" style="line-height:26px;">邮编：<span class="grey">${opt.thirdPostCode }</span></h5>
                               <h5 class="col-sm-6" style="line-height:26px;">传真：<span class="grey">${opt.thirdFax }</span></h5>
                               <h5 class="col-sm-6" style="line-height:26px;">质物名称：<span class="grey">${opt.optName }</span></h5>
                               <h5 class="col-sm-6" style="line-height:26px;">库存余额总额：<span class="grey">${opt.totalAmount }</span></h5>
                               <h5 class="col-sm-6" style="line-height:26px;">库存余额：<span class="grey">${opt.repertoryBalance }</span></h5>
                               <h5 class="col-sm-6" style="line-height:26px;">保险费：<span class="grey">${opt.insuranceCost }</span></h5>
                               <h5 class="col-sm-6" style="line-height:26px;">监管费：<span class="grey">${opt.superviseCost }</span></h5>
                               <h5 class="col-sm-6" style="line-height:26px;">库房租赁费：<span class="grey">${opt.leaseCost }</span></h5>
                               <h5 class="col-sm-6" style="line-height:26px;">其他费用：<span class="grey">${opt.otherCost }</span></h5>
	...
	<script src="<%=path%>/project/opt/optManager/ZYrepertoryPledgeView.js?v=<%=vardate%>"></script>
