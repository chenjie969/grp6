					...
					<form class="form-horizontal" role="form" id="form_baseTwo">
                          ...
                          <div class="col-sm-offset-1 col-sm-10">
							 ...
							 <c:if test="${opt.clientTypeID ne '01' }">   	
              				...
              				<h5 class="col-sm-6" style="line-height:26px;">企业合同编号：<span class="grey">${opt.companyContractCode }</span></h5>
              				<h5 class="col-sm-6" style="line-height:26px;">企业合同名称：<span class="grey">${opt.companyContractName }</span></h5>
              				<h5 class="col-sm-6" style="line-height:26px;">应收账款：<span class="grey"><fmt:formatNumber value="${opt.yearRent }" pattern="###,###.######"/>万元</span></h5>
              				<h5 class="col-sm-6" style="line-height:26px;">偿付期限：<span class="grey"><fmt:formatNumber value="${opt.leasePeriod }" pattern="####.######"/>年</span></h5>
...
<script src="<%=path%>/project/opt/optManager/ZYreceivablesPledgeView.js?v=<%=vardate%>"></script>
