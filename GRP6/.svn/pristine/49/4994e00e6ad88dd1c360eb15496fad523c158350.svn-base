...
<div class="modal fade bs-example-modal-lg" id="lawsuitAdd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">添加案件诉讼情况</h4>
      </div>
      <div class="modal-body">
		<form class="form-horizontal" role="form" id="add_lawsuitProgressForm">
						...
						<div class="row">
							<div class="col-sm-9">
								<div class="input-group">
									...
									name="workDate" id="id-date-picker-1"  data-date-format="yyyy-mm-dd" />
			...
			<div class="form-group ">
				...
				<div class="col-sm-5">
					<input type="text" name="workStatus"  class="col-sm-9 validate[required,maxSize[50]]"/>
				</div>
			</div>
			<div class="space-4"></div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<textarea class="col-sm-10 validate[maxSize[200]]" rows="5" cols="80" name="workDesc" ></textarea>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<textarea class="col-sm-10 validate[maxSize[200]]" rows="5" cols="80" name="remark" ></textarea>
					<div class="col-sm-10 no-padding-right" style="text-align:right;">
						<span class="light-grey">限制200个字符</span>
					</div>
				</div>
