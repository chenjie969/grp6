(function($,z){
	...
	function mustTransPre(costMust_ID){
		$("#feeRegister_page").load("/project/costMust/showMustTransPre",{},function(response,status,xhr){
	...
	function preTransFact(costPre_ID){
		$("#feeRegister_page").load("/project/costPre/showPreTransFact",{},function(response,status,xhr){
	...
	function addCostMust(meetingDetail_ID){
		$("#feeRegister_page").load("/project/costMust/showAddCostMustPage",{"meetingDetail_ID":meetingDetail_ID},function(response,status,xhr){
	...
	function addCostFact(meetingDetail_ID){
		$("#feeRegister_page").load("/project/costFact/showAddCostFactPage",{"meetingDetail_ID":meetingDetail_ID},function(response,status,xhr){
	...
	function addCostPre(meetingDetail_ID){
		$("#feeRegister_page").load("/project/costPre/showAddCostPrePage",{"meetingDetail_ID":meetingDetail_ID},function(response,status,xhr){
	...
	function addCostReturn(meetingDetail_ID){
		$("#feeRegister_page").load("/project/costReturn/showAddCostReturnPage",{"meetingDetail_ID":meetingDetail_ID},function(response,status,xhr){
	...
	function updateCostMust(costMust_ID){
		$("#feeRegister_page").load("/project/costMust/showUpdateCostMustPage",{"costMust_ID":costMust_ID},function(response,status,xhr){
	...
	function updateCostFact(costFact_ID){
		$("#feeRegister_page").load("/project/costFact/showUpdateCostFactPage",{"costFact_ID":costFact_ID},function(response,status,xhr){
	...
	function updateCostPre(costPre_ID){
		$("#feeRegister_page").load("/project/costPre/showUpdateCostPrePage",{"costPre_ID":costPre_ID},function(response,status,xhr){
	...
	function updateCostReturn(costReturn_ID){
		$("#feeRegister_page").load("/project/costReturn/showUpdateCostReturnPage",{"costReturn_ID":costReturn_ID},function(response,status,xhr){
	...
	function delCostReturn(costReturn_ID){
		$("#feeRegister_page").load("/project/costReturn/showDelCostReturnPage",{},function(response,status,xhr){
	...
	function delCostPre(costPre_ID){
		$("#feeRegister_page").load("/project/costPre/showDelCostPrePage",{},function(response,status,xhr){
	...
	function delCostMust(costMust_ID){
		$("#feeRegister_page").load("/project/costMust/showDelCostMustPage",{},function(response,status,xhr){
	...
	function delCostFact(costFact_ID){
		$("#feeRegister_page").load("/project/costFact/showDelCostFactPage",{},function(response,status,xhr){
