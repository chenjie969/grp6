 ...
 <%--
          ...
          <div class="form-group ">
						...
						<div class="radio col-sm-6">
                            <label style="margin-top:-5px;">
                                <input type="radio" name="isSensitiveCreditor" value="1" class="ace" >
                                <span class="lbl">是</span>
                            </label>
                            <label style="margin-top:-5px;">
                                <input type="radio" name="isSensitiveCreditor" value="0" class="ace" checked="checked">
          ...
          <div class="form-group">
          	<label class="col-md-2 control-label no-padding-right" for="form-field-1">敏感债权人數： </label>
				<div class="col-md-10">
	            	<input type="text" id="sensitiveCreditorNumber" name="sensitiveCreditorNumber"  class="col-md-2 col-lg-1 validate[maxSize[6]]" />
				</div>
          </div> -->
		    <div class="space-4"></div>
		    <div class="form-group" id="cooperation">
        ...
        <!--    <div class="space-4"></div>
          ...
          <div class="space-4"></div>
           ...
           <div class="space-4"></div>
          <div class="form-group">
          <label class="col-md-2 control-label no-padding-right" for="form-field-1"><i class="icon-asterisk orange"></i>贷款（委贷）利率： </label>
				<div class="col-md-10">
...
//选择客户
    $("body").on("keyup", "#fundNameTree", function() {
			...
			var busiClass = $("#busiClass").val(); //获取业务类型
