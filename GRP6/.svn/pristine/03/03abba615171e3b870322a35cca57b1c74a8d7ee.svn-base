      ...
      <div class="row">
		...
		<form class="form-horizontal" role="form" id="projectLawsuit_form">
			...
			<div class="space-4"></div>
			 ...
			 <div class="form-group">
	           	 <label class="col-md-2 control-label no-padding-right" for="form-field-1">案号： </label>
	             <div class="col-md-10">
	                 <input type="text" class="col-md-2 col-lg-2 validate[maxSize[18]]"  id="recordNum" name="recordNum" value="${projectLawsuit.recordNum}" />
