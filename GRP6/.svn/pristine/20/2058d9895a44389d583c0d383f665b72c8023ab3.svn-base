            ...
            <div class="row">
                <div class="cos-sm-offset-1 col-sm-10">
                    <div class="page-header">
                        <button type="button" class="btn btn-sm btn-info" id="active_apply_modal">上会申请</button>&nbsp;
                    </div>
                </div>
            </div>
        </div>
...
<script src="<%=path%>/project/onManagement/js/meeting.js?v=<%=vardate%>"></script>
