(function($,z){
	...
	/**初始化列表***/
	function initTable(){
		$("#entrusted-table").bootstrapTable('destroy');
		$('#entrusted-table').bootstrapTable({
			method: 'get',
			...
			url: "/gbpm/processInstance/selectProcessTaskDelegatePageTable",//这个接口需要处理bootstrap table传递的固定参数
