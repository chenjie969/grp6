...
<div class="modal fade" id="editProjectBillInfo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">修改票据信息</h4>
      </div>
      <div class="modal-body">
		<form class="form-horizontal" role="form" id="form_editProjectBillInfo">
			<input type="hidden" name="costBill_ID" value="${bill.costBill_ID }">
				...
				<div class="col-sm-9">
					<select class="col-xs-10 col-sm-6 validate[required]" name="billTypeID">
						...
						<c:forEach items="${billTypeList }" var="billType">
							<option value="${billType.dicTypeID }" <c:if test="${billType.dicTypeID==bill.billTypeID }">selected='selected'</c:if>>${billType.dicTypeName }</option>
						</c:forEach>
					</select>
					<input type="hidden" name="billTypeName" value="${bill.billTypeName }">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text"  class="col-xs-10 col-sm-6 validate[required,maxSize[20]]" name="billCode" value="${bill.billCode }"/>
				</div>
			</div> --%>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text"  class="col-xs-10 col-sm-10 validate[required,maxSize[50]]" name="billTitle" value="${bill.billTitle }"/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text"  class="col-xs-10 col-sm-6 validate[maxSize[20]]" name="taxCode" value="${bill.taxCode }"/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text"  class="col-xs-9 col-sm-5 validate[custom[number],maxSize[18]]" name="billSum" value="${bill.billSum }"/>
					...
					<div class="row">
						<div class="col-sm-7">
							<div class="input-group">
								<input  type="text" class="form-control date-picker validate[custom[date]]" name="billDate" data-date-format="yyyy-mm-dd"
										value="<fmt:formatDate value='${bill.billDate }' pattern='yyyy-MM-dd' type='date'/>" />
								<span class="input-group-addon">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text"  class="col-xs-10 col-sm-10 validate[maxSize[80]]" name="address"  value="${bill.address }"/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text"  class="col-xs-10 col-sm-6 validate[maxSize[20]]" name="phone" value="${bill.phone }"/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text"  class="col-xs-10 col-sm-10 validate[maxSize[50]]" name="openBank" value="${bill.openBank }"/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text"  class="col-xs-10 col-sm-6 validate[maxSize[20],minSize[20]]" name="accountNum" value="${bill.accountNum }"/>
				</div>
			</div>
