                           ...
                           <c:if test="${opt.clientTypeID eq '01' }">      
                            ...
                            <c:if test="${opt.clientTypeID ne '01' }">      
                              ...
                              <div class="form-group col-sm-6">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" id="companyContractCode" placeholder="" name="companyContractCode" class="col-sm-6 validate[maxSize[50]]" value="${opt.companyContractCode }"/>
                                  </div>
                              </div>
                              ...
                              <div class="form-group col-sm-6">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" id="companyContractName" placeholder="" name="companyContractName" class="col-sm-6 validate[maxSize[50]]" value="${opt.companyContractName }"/>
                                  </div>
                              </div>
                              ...
                              <div class="form-group col-sm-6">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" id="yearRent" placeholder="" name="yearRent" class="col-sm-4 validate[required,custom[number],maxSize[18]]" value="<fmt:formatNumber value="${opt.yearRent }" pattern="####.######"/>"/>
                              ...
                              <div class="form-group col-sm-6">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" id="leasePeriod" placeholder="" name="leasePeriod" class="col-sm-4 validate[custom[number],maxSize[18]]" value="<fmt:formatNumber value="${opt.leasePeriod}" pattern="####.######"/>"/>
...
<script src="<%=path%>/project/opt/optManager/ZYreceivablesPledgeEdit.js?v=<%=vardate%>"></script>
