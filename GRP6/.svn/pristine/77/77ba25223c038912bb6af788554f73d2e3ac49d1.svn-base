...
<% 
	ReportParam rp4 = (ReportParam)request.getAttribute("reportParam");
%>
 <div class="modal fade" id="reportSelect_yearMonth_group" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"  data-backdrop="static" data-keyboard="false">
             ...
             <form class="form-horizontal" role="form" id="reportSelect_form_yearMonth_group">
                 <div class="space-4"></div>
                  <div class="form-group" >
                  
                  <div>
	   				  <label class="col-sm-3 control-label no-padding-right " for="form-input">统计年月： </label>
	   			      <div class="col-sm-9 ">
                  ...
                  <div class="modal-footer">
                      <button class="btn btn-primary btn_submit" type="button" data-statsCondition='<%=JSON.toJSON(rp4) %>'>
