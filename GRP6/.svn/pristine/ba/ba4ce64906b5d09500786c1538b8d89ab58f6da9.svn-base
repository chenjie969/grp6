...
<div class="page-content"><!--begin页面内容  -->
	<div class="page-header"><!--begin页头部分 -->
          ...
          <input type="hidden" id="productInstance_ID" value="${productInstance.productInstance_ID}">  
          <input type="hidden" id="status" value="${riskScheme.status}">  
          <!--   产品id -->
          ...
          <input type="hidden" id="nodeNames" class="" name="nodeNames" value="${runNode.nodeNames}">
          <!-- 创建人ID -->
            ...
            <div class="row"><!--begin 响应式行  -->
              <div class="col-xs-12"><!--begin 响应式列  -->
                ...
                <div class="widget-main">
                    ...
                    <hr>
                    <div class="row">
                        <h5 class="col-sm-3" id="busiCode">标题：<span class="grey">${riskScheme.title}</span></h5>
                        <h5 class="col-sm-3" id="createUserName">创建人：<span class="grey sprojectName">${riskScheme.createUserName}</span></h5>
                        <h5 class="col-sm-3" id="createDate">创建时间：<span class="grey sprojectName"><fmt:formatDate value="${riskScheme.createDate}" type="date"/> </span></h5>
                        <h5 class="col-sm-3 red" id="" >
                        ...
                        <input type="hidden" id="apply_ID" class="apply_ID"  value="${riskScheme.riskScheme_ID}"><!-- 正在运行节点id -->
                  ...
                  <div class="row-fluid wizard-actions">
                    ...
                    <c:if test="${!productInstance.isReturn || productInstance.returnType != '01'}">
                      ...
                      <button class="btn btn-info btn-next btn_finisheScheme" data-last="Finish">
                             审批完成
                        <i class="icon-arrow-right icon-on-right"></i>
                      </button>
                    <c:if test="${productInstance.isReturn && productInstance.returnType == '01'}">
...
<div id="projectBeforeDeal_page"></div>
<div id="nodeTaskModal_page"></div>
<div id="processStart_page"></div>
<script src="<%=path %>/project/riskResponse/keyProject/riskProjectDeal.js?v=<%=vardate%>"></script>
