                           ...
                           <%-- <div id="isHaveOtherDIV">
                        	...
                        	<div  id="isProxyDIV">
                              ...
                              <div class="form-group col-sm-6">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" id="landCode" placeholder="" name="landCode" class="col-sm-6 validate[required,maxSize[50]]" />
                                  </div>
                              </div>
                              ...
                              <%-- <div class="form-group col-sm-6">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" id="landSource" placeholder="" name="landSource" class="col-sm-6 validate[required,maxSize[50]]" />
                                  </div>
                              </div> --%>
                              ...
                              <div class="form-group col-sm-6">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" id="pledgeLandArea" name="pledgeLandArea" class="col-sm-4 validate[required,maxSize[50]]" />
                                      <span style="line-height:28px;">&nbsp;（面积单位自由填写）</span>
                                  </div>
                              </div>
...
<script src="<%=path%>/project/opt/optManager/DYlandGuaranty.js?v=<%=vardate%>"></script>
