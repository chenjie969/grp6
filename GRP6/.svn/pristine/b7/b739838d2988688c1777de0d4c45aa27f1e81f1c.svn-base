...
<div class="modal fade" id="autoAddConfrim" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false" style="z-index:9999">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
      		<div class="alert bigger-110">
				...
				<span id="confirmValue">执行自动生成会删除已有的还款计划及应收费用信息，是否继续？</span>
			</div>
      </div>
