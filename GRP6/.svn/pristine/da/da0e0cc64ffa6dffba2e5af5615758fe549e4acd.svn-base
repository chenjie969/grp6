...
<div class="page-content">   
      <div class="row">
		...
		<form class="form-horizontal" role="form" id="projectDelayRgister_form">
	       ...
	       <div class="space-4"></div>
           <div class="form-group">
	           	 <label class="col-md-2 control-label no-padding-right" for="form-field-1"> <i class="icon-asterisk orange"></i>展期后担保费率： </label>
	             <div class="col-md-10">
	       ...
	       <div class="space-4"></div>
           <div class="form-group">
	           	 <label class="col-md-2 control-label no-padding-right" for="form-field-1"> <i class="icon-asterisk orange"></i>展期后融资服务费率： </label>
	             <div class="col-md-10">
...
<script src="<%=path %>/project/apply/projectDetailProjectDelay.js?v=<%=vardate%>"></script> 