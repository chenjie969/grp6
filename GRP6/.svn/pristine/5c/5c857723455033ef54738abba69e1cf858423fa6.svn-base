                           ...
                           <c:if test="${opt.clientTypeID eq '01' }">      
                            ...
                            <c:if test="${opt.clientTypeID ne '01' }">      
                              ...
                              <div class="form-group col-sm-12">
                                  <label class="col-sm-2 control-label no-padding-right" for="form-input">是否存在第三方： </label>
                                      <div class="radio">
                        ...
                        <div id="isUseOtherDIV">
                        	 ...
                        	 <div class="col-sm-6 form-group hidden-xs " style="height: 30px"></div>
                              ...
                              <div class="form-group col-sm-6">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" id="count" name="count" value="${opt.count }" class="col-sm-6 validate[custom[number],maxSize[10]]" />
                                  </div>
                              </div>
...
<%@ include file="/project/opt/optManager/common_optEdit.jsp" %>
	<script src="<%=path%>/project/opt/optManager/DYotherGuarantyEdit.js?v=<%=vardate%>"></script>
