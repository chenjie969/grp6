					...
					<div class="row">
						<div class="col-xs-10 col-sm-11 ">
							<div class="input-group select_user_tree_roles">
								<input class="form-control" autoField="user_uids" name="user_names" id="select_user_tree_roles" type="text" value="${roles.user_names}" dataValue="${roles.user_uids}" maxlength="204800"/>
					...
					<div class="row">
						<div class="col-xs-10 col-sm-11 ">
							<div class="input-group select_user_tree_roles-userGroup">
								<input class="form-control" autoField="userGroup_uuids" name="userGroupNames" id="select_user_tree_roles-userGroup" type="text" value="${roles.userGroupNames}" dataValue="${roles.userGroup_uuids}" />
								<span class="input-group-addon ">
									<i class="icon-caret-down bigger-110  "></i>
								</span>
							</div>
