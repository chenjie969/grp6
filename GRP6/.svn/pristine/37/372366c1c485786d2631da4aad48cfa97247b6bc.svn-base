...
<style>
                          ...
                          <div class="col-sm-offset-1 col-sm-10">
							 ...
							 <c:if test="${opt.clientTypeID ne '01' }">   	
								...
								<h5 class="col-sm-6" style="line-height:26px;">身份证号码：<span class="grey">${opt.otherPersonNum }</span></h5>
                          		...
                          		<h5 class="col-sm-6" style="line-height:26px;">专利名称：<span class="grey">${opt.patentName }</span></h5>
                          		<h5 class="col-sm-6" style="line-height:26px;">专利号：<span class="grey">${opt.patentCode }</span></h5>
                          		<h5 class="col-sm-6" style="line-height:26px;">申请日期：<span class="grey">
                          			<fmt:formatDate value="${opt.appalyDate }"  pattern="yyyy-MM-dd"/></span></h5>
                          			
                          		<h5 class="col-sm-6" style="line-height:26px;">颁证日期：<span class="grey">
                          			<fmt:formatDate value="${opt.certificateDate }"  pattern="yyyy-MM-dd"/></span></h5>	
                          			
                          		<h5 class="col-sm-6" style="line-height:26px;">有效期：<span class="grey">${opt.validPeriod }</span></h5>
                          		<h5 class="col-sm-6" style="line-height:26px;">账号：<span class="grey">${opt.depositAccounts }</span></h5>
                          		<h5 class="col-sm-6" style="line-height:26px;">维持专利权义务：<span class="grey">${opt.patentDuty }</span></h5>
                          		<h5 class="col-sm-6" style="line-height:26px;">保管费：<span class="grey">
                          			<fmt:formatNumber value="${opt.custodyCost }" pattern="####.######"/></span></h5>
	...
	<script src="<%=path%>/project/opt/optManager/ZYpatentPledgeView.js?v=<%=vardate%>"></script>
