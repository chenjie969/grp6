...
<div class="modal fade bs-example-modal-sm" id="editLawSuitModal"
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">修改项目诉讼</h4>
			</div>
			<div class="modal-body">		
				<form class="form-horizontal row" role="form" id="editLawSuit_Form">	
					
				<input type="hidden" name="projectLawsuit_ID" id="projectLawsuit_ID" value="${LawSuit.projectLawsuit_ID}"/>			
					<div class="form-group col-sm-6">
						...
						<div class="col-sm-8">
							...
							value="${LawSuit.recordNum}"	class=" col-sm-10 ztb_add validate[required,maxSize[25]]" />
						</div>
					</div>
					<div class="form-group col-sm-6">
						<label class="col-sm-4 control-label no-padding-right"
						...
						<div class="col-sm-8">
							<input type="text" name="plaintiff" id="plaintiff" value="${LawSuit.plaintiff}" class=" col-sm-10 ztb_add validate[required,maxSize[50]]" />
						</div>
					</div>
					<div class="form-group col-sm-6">
						<label class="col-sm-4 control-label no-padding-right"
						...
						<div class="col-sm-8">
							<input type="text" name="defendant" id="defendant" value="${LawSuit.defendant}" class=" col-sm-10 ztb_add validate[required,maxSize[50]]" />
						</div>
					</div>
					<div class="form-group col-sm-6">
						<label class="col-sm-4 control-label no-padding-right"
						...
						<div class="col-sm-8">
							<input type="text" name="lawsuitSum" id="lawsuitSum" value="${LawSuit.lawsuitSum}" class=" col-sm-10 ztb_add validate[required,custom[number],maxSize[18]]" />万元
						</div>
					</div>
					...
					<div class="form-group ">
						...
						<div class="col-sm-8">
							<input type="text" name="lawCourt" id="lawCourt"
								class=" col-sm-12 ztb_add validate[required,maxSize[100]]"   value="${LawSuit.lawCourt}"/>
						</div>
					</div>
					...
					<div class="form-group col-sm-12">
						...
						<div class="col-sm-10">
							<textarea
								...
								rows="5" name="caseInfo" id="caseInfo">${LawSuit.caseInfo}</textarea>
					...
					<div class="form-group col-sm-12">
						...
						<div class="col-sm-10">
							<textarea
								class="col-sm-10 limited  ztb_edit_dynamicContent validate[maxSize[2000]]"
								rows="5" name="propertyInfo" id="propertyInfo">${LawSuit.propertyInfo}</textarea>
							<div class="col-sm-10 no-padding-right">
								<span class="light-grey pull-right">限制2000个字符</span>
							</div>
						</div>
