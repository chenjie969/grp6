...
<div class="modal fade" id="viewPersonApply" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">查看个人咨询情况</h4>
      </div>
      <div class="modal-body">
      	<div class="row">
			<div class="col-sm-offset-1 col-sm-10">
				<!-- <div class="col-sm-6">
					<div class="row">
						<h5 class="col-sm-12">客户类型：<span class="grey">个人客户</span></h5>
					</div>
				</div> -->
				<div class="col-sm-6">
					<div class="row">
						<h5 class="col-sm-12" style="line-height:26px;">申请人姓名：<span class="grey" >${apply.clientName }</span></h5>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="row">
						<h5 class="col-sm-12" style="line-height:26px;">申请编号：<span class="grey" >${apply.applyNum }</span></h5>
					</div>
				</div>
				<div class="col-sm-12 col-xs-12">
					<div class="row">
						<h5 class="col-sm-12" style="line-height:26px;">身份证号码：<span class="grey">${apply.certificateCode }</span></h5>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="row">
						<h5 class="col-sm-12" style="line-height:26px;">手机：<span class="grey">${apply.phone }</span></h5>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="row">
				...
				<div class="col-sm-6">
					<div class="row">
						<h5 class="col-sm-12" style="line-height:26px;">业务品种：<span class="grey" >${apply.busiTypeName }</span></h5>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="row">
				...
				<div class="col-sm-6">
					<div class="row">
						<h5 class="col-sm-12" style="line-height:26px;">申请金额：<span class="grey"><fmt:formatNumber value="${apply.applySum }" pattern="###,###.######"/>万元</span></h5>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="row">
				...
				<div class="col-sm-6">
					<div class="row">
						<h5 class="col-sm-12" style="line-height:26px;">接待部门：<span class="grey" >${apply.receiveDeapartName }</span></h5>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="row">
						<h5 class="col-sm-12" style="line-height:26px;">接待人：<span class="grey">${apply.receiveUserName }</span></h5>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="row">
						<h5 class="col-sm-12" style="line-height:26px;">接待日期：<span class="grey">
			...
			<%-- 
			<div class="col-sm-6">
				<h5 class="col-sm-4 align-right">客：</h5><h5 class="grey col-sm-8 no-padding-left">${apply. }</h5>
			</div>
			<div class="col-sm-6">
				<h5 class="col-sm-4 align-right">客：</h5><h5 class="grey col-sm-8 no-padding-left">${apply. }</h5>
			</div>
