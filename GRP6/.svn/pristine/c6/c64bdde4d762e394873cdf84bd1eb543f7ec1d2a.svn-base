    ...
    <div class="modal-dialog" style="z-index:999999">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-default" id="btnClose2" data-dismiss="modal"><i
...
<script src="<%=path%>/sys/dataBaseVindicate/documentList/documentUpload.js?v=<%=vardate%>"></script>
<%@ include file="/project/opt/imgUpload/delPicture.jsp" %>
<script>
	var pledgeFile='${opt.optGuaranty_ID}'+'_realize';
	$("#pledgeFile").val(pledgeFile);
</script>
