...
/**
 * 已完成任务事项表gbpm_finishTask
 * @author zky
 *
 */
public class Gbpm_finishTask implements Serializable {
	private String 	finishTask_ID	;//	已完成任务事项ID	varchar(32)
	...
	private String	taskMangerID	;//	任务ID	varchar(32)
	...
	private String	operationType	;//	操作类型 必做任务 选做任务
	private Boolean	isBeforeTask	;//	是否有前置任务	bool
	private String	beforeTaskID	;//	前置任务ID	varchar(32)
	private String	beforeTaskName	;//	前置任务ID	varchar(32)
	...
	private String	warnMethodNameList	;//	提醒方式名称集合（可以多个逗号隔开）	varchar(100)
	private Boolean	isStartProcess	;//	是否启动流程	bool
	private String	processID	;//	流程ID	varchar(32)
	private String	processName	;//	流程名称	varchar(32)
	private String operaterTypeID	;//	操作者类型ID	varchar(32)
	private String	operaterTypeName	;//	操作者类型名称	varchar(20)
	private String	operatorID	;//	操作者详细类型	varchar(32)
	private String	operatorName	;//	操作者详细名称	varchar(20)
	...
	private Integer number; //冗余字段  分组统计任务事项个数
	...
	public String getFinishTask_ID() {
		return finishTask_ID;
	}
	public void setFinishTask_ID(String finishTask_ID) {
		this.finishTask_ID = finishTask_ID;
	}
