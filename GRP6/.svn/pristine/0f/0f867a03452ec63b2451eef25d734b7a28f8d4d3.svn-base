...
<style>
                           ...
                           <c:if test="${opt.clientTypeID eq '01' }">      
                            ...
                            <c:if test="${opt.clientTypeID ne '01' }">      
                              ...
                              <div class="form-group col-sm-6">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" id="unitName" name="unitName"  class="col-sm-6 validate[maxSize[50]]" value="${opt.unitName }"/>
                                  </div>
                              </div>
                              ...
                              <div class="form-group col-sm-6">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" id="count" placeholder="" name="count" class="col-sm-6 validate[custom[number],maxSize[6]]" value="<fmt:formatNumber value="${opt.count }" pattern="####.######"/>"/>
                                  </div>
                              </div>
                              ...
                              <div class="form-group col-sm-6">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" id="oldValue" placeholder="" name="oldValue" class="col-sm-4 validate[custom[number],maxSize[18]]" value="<fmt:formatNumber value="${opt.oldValue }" pattern="####.######"/>"/>
	...
	<script src="<%=path%>/project/opt/optManager/ZYinventoryPledgeEdit.js?v=<%=vardate%>"></script>
