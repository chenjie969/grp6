			...
			<div class="col-xs-12">
                ...
                <div class="col-sm-12">
					<div class="table-responsive"  id="loadinfo">
						 <table id="projectCreditor-table" style="font-size:13px !important;"></table>  
                    </div>
                </div>
			</div>
			<!-- PAGE CONTENT ENDS -->
		</div><!-- /.row -->
		<div id="projectCreditor_page"></div>
	</div><!-- /.page-content -->
	<script type="text/javascript" src="<%=path %>/project/creditor/projectCreditor.js?v=<%=vardate%>"></script>
