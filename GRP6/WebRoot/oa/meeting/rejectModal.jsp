            ...
            <div class="modal-body">
                <form class="form-horizontal row" role="form" id="meeting_reject_form">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="returnDesc"><i
                                class="icon-asterisk orange"></i>拒绝原因：</label>

                        <div class="col-sm-9">
                            <textarea rows="6" id="returnDesc" name="returnDesc"
                                      class="col-sm-10 validate[required,maxSize[100]]"></textarea>
