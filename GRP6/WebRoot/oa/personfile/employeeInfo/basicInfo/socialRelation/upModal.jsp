...
<div class="modal fade bs-example-modal-sm" id="updateSocialRelaModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">修改社会关系</h4>
      </div>
      <div class="modal-body"> 
		<form class="form-horizontal" role="form" id="updateSocialRela_Form"> 	
                  <input type="hidden" id="socialID" name="socialID" value="${hrstaffRelation.socialID}"/>
	      ...
	      <div class="form-group ">
						...
						<div class="col-sm-9">
							<label class="radio-inline"> 
							 <input type="radio" value="男" name="socialSex" <c:if test="${hrstaffRelation.socialSex eq '男' }">checked="checked"</c:if>>男
							</label> 
							<label class="radio-inline">
							 <input type="radio" value="女" name="socialSex" <c:if test="${hrstaffRelation.socialSex ne '男' }">checked="checked"</c:if>>女
							</label>
