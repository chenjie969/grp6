...
<div class="modal fade bs-example-modal-sm" id="jobAddModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">添加职务情况</h4>
      </div>
      <div class="modal-body">
		<form class="form-horizontal" role="form" id="jobAdd_Form"> 	
                  <input type="hidden" id="staffcase_Id" name="staffcase_Id" value="${hrstaffDuty.staffcase_Id}"/>        
	         ...
	         <div class="form-group ">
			        ...
			        <div class="col-sm-9">
							<div class="col-md-6 col-sm-6 input-group allDepartsTree3">
								<input type="text" class="form-control " autoField="dutyDepGID" id="allDepartsTree3" value="${hrstaffDuty.dutyDepGID}" name="departName3"
