...
<div class="modal fade" id="allAnnounceView" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
					...
					<br/>	<br/>
						<div class="tabbable">
							...
							<div class="tab-content" style="height:120px;">
								...
								<div id="signDetail" class="tab-pane in active">
									<div class="col-sm-12">
										<label class="row col-sm-12 control-label no-padding-right" for="form-input">共<font style="font-weight:bold;color:red;">${megUser.signedCount}</font>人已签收:</label>
										<div class="space-4"></div>
										<br/><br/>
										<div class="row col-sm-12">
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<c:if test="${message.signedUserNameList eq null}">（空）</c:if>
											 <c:if test="${message.signedUserNameList ne null}">
								...
								<div id="noSignDetail" class="tab-pane">
									<div class="col-sm-12">
										<label class="row col-sm-12 control-label no-padding-right" for="form-input">共<font style="font-weight:bold;color:red;">${megUser.noSignCount}</font>人未签收:</label>
										<div class="space-4"></div>
										<br/><br/>
										<div class="row col-sm-12">
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<c:if test="${message.noSignUserNameList eq null}">（空）</c:if>
											 <c:if test="${message.noSignUserNameList ne null}">
