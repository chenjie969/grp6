...
<div class="modal fade" id="AuditAnnounce" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary preview" id="btn_pageAuditPass"> <i class='icon-ok bigger-110' ></i>审核通过</button>
        <button type="button" class="btn btn-primary preview" id="btn_pageAuditReturn"> <i class='icon-mail-reply bigger-110'></i>审核退回</button>
