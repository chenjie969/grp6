                                    ...
                                    <div class="col-sm-9">
										   ...
										   <div class="tabbable">
												<ul class="nav nav-tabs" id="announceTab">
													...
													<li>
														<a data-toggle="tab" href="#noSign" id="yesCheckTab">
															已通过
														</a>
													</li>
													<li>
												...
												<div class="tab-content">
													...
													<div id="noCheck" class="tab-pane in active">
														<%@ include file="/oa/info/announcement/announce/noCheckAnnounce.jsp" %>
													</div>
													<div id="noSign" class="tab-pane">
														<%@ include file="/oa/info/announcement/announce/yesCheckAnnounce.jsp" %>
													</div>
													<div id="bounced" class="tab-pane">
														<%@ include file="/oa/info/announcement/announce/auditBouncedAnnounce.jsp" %>
													</div>
...
<script src="<%=path %>/oa/info/announcement/audit_announce.js?v=<%=vardate%>"></script>
<script src="<%=path %>/oa/info/announcement/announce/auditBouncedAnnounce.js?v=<%=vardate%>"></script>
<script src="<%=path %>/oa/info/announcement/announce/noCheckAnnounce.js?v=<%=vardate%>"></script>  
<script src="<%=path %>/oa/info/announcement/announce/yesCheckAnnounce.js?v=<%=vardate%>"></script>
