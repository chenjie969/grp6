...
<% 
	ReportParam rp6 = (ReportParam)request.getAttribute("reportParam");
%>
 <div class="modal fade" id="reportSelect_beginAndEnd_group" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"  data-backdrop="static" data-keyboard="false">
             ...
             <form class="form-horizontal" role="form" id="reportSelect_form_beginAngEnd_group">
                 <div class="space-4"></div>
                  ...
                  <div class="modal-footer">
                      <button class="btn btn-primary btn_submit" type="button" data-statsCondition='<%=JSON.toJSON(rp6) %>'>
