...
<div class="modal fade" id="materialModelEdit_page" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">修改客户资料清单模板</h4>
      </div>
      <div class="modal-body">
      	 <form class="form-horizontal row" role="form" id="materialModelEdit_Form">
			...
			<div class="form-group ">
				...
				<div class="col-sm-8 ">
					<div class="row">
					    <div class="col-xs-10">
							<input type="text" name="materialModelName" id="edit_materialModelName" class="col-xs-12 validate[required,maxSize[50]]" value="${materialModel.materialModelName}"/>
						</div>
			        </div>
				</div>
			</div>
      ...
      <div class="modal-footer ">
        <button type="button" class="btn btn-primary " id="btn_updateOneMaterialModel"> <i class='icon-ok bigger-110'></i>保存</button>
