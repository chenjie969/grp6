...
<div class="modal fade bs-example-modal-sm" id="hightSelectPersonClient" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		<form class="form-horizontal row" role="form" id="hightSelect_personClientForm">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" name="clientName" class="col-xs-10 col-sm-9 ztb_hightSelect validate[maxSize[50]]" />
				</div>
			</div>	
			<div class="space-4"></div>
			<div class="form-group ">
