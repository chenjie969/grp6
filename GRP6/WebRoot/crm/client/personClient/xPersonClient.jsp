...
<%@ include file="/common_foot.jsp" %>
	...
	<input type="hidden" name="clientTypeID" class="clientTypeID" value="03">
			...
			<div class="col-xs-12">
				<div class="page-header">
					...
					<button type="button" name="button" class="btn btn-sm btn-info" id="btn_hightSelect" >高级查询</button>
				 	<button type="button" name="button" class="btn btn-sm btn-info" id="xbtn_synchro" >同步到项目</button>
	...
	<script src="<%=path %>/crm/client/personClient/xPersonClient.js?v=<%=vardate%>"></script>
	...
	<%@ include file="/crm/client/personClient/xPersonClientAdd.jsp" %>
	<%@ include file="/crm/client/personClient/personClientDel.jsp" %>
	<%@ include file="/crm/client/personClient/hightSelectXPersonClient.jsp" %>
