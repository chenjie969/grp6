...
<div class="modal fade" id="addPayTaxInfo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">新增纳税情况</h4>
      </div>
      <div class="modal-body">
      	 <form class="form-horizontal row" role="form" id="add_payTaxInfo_form">
			...
			<div class="form-group col-xs-12">
				...
				<div class="col-sm-9 col-xs-12">
					<div class="row">
					    <div class="col-xs-10">
							<input type="text" name="accountSum" class="col-xs-8 validate[required,maxSize[18],custom[number]]"/>
			...
			<div class="form-group col-xs-12">
				...
				<div class="col-sm-9 col-xs-12">
					<div class="row">
					    <div class="col-xs-10">
							<input type="text" name="taxSum" class="col-xs-8 validate[required,maxSize[18],custom[number]]"/>
							<span class="col-xs-4" style="line-height:28px;">万元</span>
						</div>
			        </div>
				</div>
