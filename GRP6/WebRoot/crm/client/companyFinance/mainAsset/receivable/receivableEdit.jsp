...
<div class="modal fade" id="ReceivableEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">修改应收账款</h4>
      </div>
      <div class="modal-body">
			<form class="form-horizontal" role="form" id="edit_receivableFrom">
			<input type="hidden" name="client_ID" class="ztb_edit_client_ID client_ID" value="">
			<input type="hidden" name="receivable_ID" class="ztb_edit_receivable_ID" id="receivable_ID">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary btn_submit" id="saveReceivableEdit"><i class='icon-ok bigger-110'></i>保存</button>
