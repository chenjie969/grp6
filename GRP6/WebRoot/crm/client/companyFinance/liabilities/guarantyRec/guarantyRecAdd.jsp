...
<div class="modal fade" id="addGuarantyRec" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">新增对外担保</h4>
      </div>
      <div class="modal-body">
      	 <form class="form-horizontal row" role="form" id="add_guarantyRec_form">
			...
			<div class="form-group col-xs-12">
				...
				<div class="col-sm-9 col-xs-12">
					<div class="row">
					    <div class="col-xs-11">
							<input type="text" name="guarantyUnit" class="col-sm-12 validate[required,maxSize[25]]"/>
						</div>
			        </div>
				</div>
			</div>
			<div class="form-group col-xs-12">
				...
				<div class="col-sm-9 col-xs-12">
					<div class="row">
					    <div class="col-xs-11">
							<input type="text" name="guarantySum" class="col-xs-6 validate[required,maxSize[18],custom[number]]"/>
			...
			<div class="form-group col-xs-12">
				...
				<div class="col-sm-9 col-xs-12">
					<div class="row">
					    <div class="col-xs-11">
							<textarea class="col-xs-12 validate[maxSize[100]]"   name="eachOther" rows="5"></textarea>
