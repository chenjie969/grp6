...
<div class="modal fade" id="addPersonApply" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">个人咨询业务登记</h4>
      </div>
      <div class="modal-body">
      	 <form class="form-horizontal row" role="form" id="add_personApply_form">
      	 	<input type="hidden" name="clientType" value="02">
			<div class="form-group col-sm-6">
				<label class="col-sm-4 control-label no-padding-right" for="form-field-1"><i class="icon-asterisk orange"></i>申请人姓名： </label>
				<div class="col-sm-8">
					<div class="row">
					    <div class="col-sm-10">
							<input type="text" name="clientName" class="col-sm-12 validate[required,maxSize[50]]" id="add_personName"/>
						</div>
			        </div>
				</div>
			</div>
			<div class="form-group col-sm-6">
				...
				<div class="col-sm-8">
					<div class="row">
					    <div class="col-sm-10">
							<input type="text" name="certificateCode" class="col-sm-12 validate[required,maxSize[18],minSize[18]]" />
						</div>
			        </div>
				</div>
			</div>
			...
			<div class="form-group  col-sm-6">
				...
				<div class="col-sm-8">
					<div class="row">
						<div class="col-sm-10">
			        		<input type="hidden" id="clientSourceName" name="clientSourceName" class="ztb_clientSourceName">
							<select class="col-sm-12 select_clientSource  btn_ztb_select validate[required]"  name="clientSourceID" class_name="ztb_clientSourceName" id="select_clientSource"></select>
						</div>	
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<textarea rows="2" name="clientSourceDesc" class="col-sm-10 validate[maxSize[50]]"></textarea>
