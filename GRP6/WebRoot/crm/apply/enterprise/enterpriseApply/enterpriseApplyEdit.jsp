...
<div class="modal fade" id="editEnterpriseApply" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">修改企业咨询情况</h4>
      </div>
      <div class="modal-body">
      	 <form class="form-horizontal row" role="form" id="edit_enterpriseApply_form">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" name="clientName" class="col-sm-10 validate[required,maxSize[50]]" value="${apply.clientName }" id="edit_clientName"/>
				</div>
			</div>
