...
<div class="modal fade" id="editPersonDepot" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">修改个人储备库</h4>
      </div>
      <div class="modal-body">
      	 <form class="form-horizontal row" role="form" id="edit_personDepot_form">
			...
			<div class="form-group col-sm-6">
				...
				<div class="col-sm-8">
					<div class="row">
					    <div class="col-sm-10">
							<input type="text" name="clientName" class="col-sm-12 validate[required,maxSize[50]]" value="${apply.clientName }" id="edit_personDepotName"/>
						</div>
			        </div>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<textarea rows="2" name="clientSourceDesc" class="col-sm-10 validate[maxSize[50]]">${apply.clientSourceDesc }</textarea>
			...
			<div class="form-group col-sm-6">
 			...
 			<div class="form-group">
				<label class="col-sm-2 control-label no-padding-right" for="form-field-1">不同意受理原因： </label>
				<div class="col-sm-10">
					<textarea rows="5" name="noAgreeDesc" class="col-sm-10  validate[maxSize[250]]">${apply.noAgreeDesc }</textarea>
					<div class="col-sm-10 no-padding-right">
