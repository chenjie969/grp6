(function ($, z) {
        ...
        uploader = new plupload.Uploader({
            ...
            init: {
                ...
                UploadComplete: function (up, files) { //上传成功后，在页面进行显示
                	...
                	var type =defParam.uploadParam.fileTwoType;//文件类型
    ...
    function filesUpdate(entityID){
    	//处理entityID 
    	var strs = entityID.split("_"); 
    	var entityID = strs[0];
    	var fileTwoType = strs[1];
//    	alert("entityID:"+entityID+"   "+"fileTwoType:"+fileTwoType);
		var defParam = {
	            ...
	            "uploadParam": {
	    				...
	    				"fileTwoType":fileTwoType,//附件上传入口分类
	    				"clientID":"",//客户id
	    				"projectID":"",//项目id
	    				"fileFlag":"01",
	    				"entityID":entityID,
