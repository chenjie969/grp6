	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div class="col-sm-10 col-sm-offset-1">
				...
				<div class="widget-header widget-header-flat">
						<button type="button" style="margin-right:10px;line-height:37px;display:block;text-decoration:none;"  id="btn_addIntentionLetter3">
									<i class="icon-edit bigger-110 orange" ></i>
									<span class="bigger-110 no-text-shadow orange">生成《**经理办公会评议项目情况简表（Ⅱ）》</span>
						</button>
					<input type="hidden" id="hidden_flowID" value="${flowID }">
					<input type="hidden" id="hidden_applyID" value="${apply_ID }">
				</div>
				<div class="widget-header widget-header-flat">
						<button type="button" style="margin-right:10px;line-height:37px;display:block;text-decoration:none;"  id="btn_addIntentionLetter2">
									<i class="icon-edit bigger-110 orange" ></i>
									<span class="bigger-110 no-text-shadow orange">生成《拟推荐上会项目清单（Ⅰ/Ⅱ）》</span>
						</button>
					<input type="hidden" id="hidden_flowID" value="${flowID }">
					<input type="hidden" id="hidden_applyID" value="${apply_ID }">
				</div>
