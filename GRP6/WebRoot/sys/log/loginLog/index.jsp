								...
								<div class="page-header col-sm-12">
					         	...
					         	<div class="col-md-3">
									...
									<button class="btn btn-info btn-sm" id="search"><i class="icon-search"></i>查询</button>
               						<button class="btn btn-default btn-sm pull-right" id="cleanAll" >清空日志</button>
...
<%@ include file="/common_foot.jsp" %>
	...
	<script src="<%=path %>/sys/log/loginLog/index.js?v=<%=vardate%>"></script>

	<%@ include file="/sys/log/loginLog/view.jsp" %>
	<%@ include file="/sys/log/loginLog/del.jsp" %>
	<%@ include file="/sys/log/loginLog/delAll.jsp" %>
