...
<div class="modal fade" id="editMultilevelsort" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">修改多级字典</h4>
      </div>
      <div class="modal-body">

			<form class="form-horizontal" role="form" id="edit_form">
			<input type="hidden" name="multilevelsortid" class="ztb_edit_multilevelsortid">
			<input type="hidden" name="pmultilevelsortid" class="ztb_edit_pmultilevelsortid">
			<input type="hidden" name="unitUid" class="ztb_edit_unitUid">
			<input type="hidden" name="multilevelsortfullcode" class="ztb_edit_multilevelsortfullcode">
			...
			<div class="form-group ">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> <i class="icon-asterisk orange"></i>多级字典名称： </label>
				<div class="col-sm-9">
					<input type="text" name="multilevelsortname" id="edit_multilevelsortname"  class="col-xs-10 col-sm-11 ztb_edit_multilevelsortname ztb_add validate[required,maxSize[50]]" />
				</div>
			</div>
			
			<!-- <div class="space-4"></div>
			<div class="form-group ">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1">多级字典编号： </label>
				<div class="col-sm-9">
