...
<div class="modal fade" id="costMustToDelay" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false" style="z-index:9999">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">应收转缓收</h4>
      </div>
      <div class="modal-body">
		<form class="form-horizontal" role="form" id="form_costMustToDelay">
			...
			<div class="form-group">
				...
				<label class="col-sm-8" for="form-field-1"><fmt:formatNumber value="${costMust.mustCostSum }" pattern="###,###.##"/>元</label>
				<input type="hidden" name="delayCostSum" value="${costMust.mustCostSum }">
			</div>
			<div class="form-group">
      ...
      <div class="modal-footer">
			<button type="button" class="btn btn-primary btn_submit"><i class='icon-ok bigger-110'></i>转入缓收费用</button>
