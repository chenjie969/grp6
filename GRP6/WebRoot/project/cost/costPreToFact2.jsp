...
<div class="modal fade" id="costPreToFact" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false" style="z-index:9999">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">预收转实收</h4>
      </div>
      <div class="modal-body">
		<form class="form-horizontal" role="form" id="form_costPreToFact">
			...
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1"><i class="icon-asterisk orange"></i>实收费用： </label>
				<div class="col-sm-8">
					<input type="text" name="factCostSum" class="col-sm-6 validate[required,custom[number],maxSize[18]],custom[isMoreThanRemainedPre]" id="costSum"/>
					...
					<div class="row">
						<div class="col-sm-10">
							<div class="input-group">
								<input class="form-control date-picker validate[required,custom[date]]" type="text" data-date-format="yyyy-mm-dd" name="factCostDate"
								 	id="date-picker-1"/>
								<span class="input-group-addon">
