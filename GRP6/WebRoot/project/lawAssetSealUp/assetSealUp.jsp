...
<div class="page-content">   
      <div class="row">
		...
		<form class="form-horizontal" role="form" id="asserSealUp_form">
	             ...
	             <div class="col-md-10">
	                  <select id="guarantyOrgList" class="col-sm-5 validate[required]"  name="affiliateGroup"  >		
						...
						<c:forEach items="${guarantyOrgList}" var="guarantyOrg">
							<option value="${guarantyOrg.dicTypeName}" <c:if test="${proSeaulUp.affiliateGroup eq guarantyOrg.dicTypeName}"> selected="selected"</c:if>>${guarantyOrg.dicTypeName}</option>
						</c:forEach>
				    </select>
	             </div>
			</div>
	      ...
	      <div class="form-group">
	           	 <label class="col-md-2 control-label no-padding-right" for="form-field-1"> 资产保全方式：</label>
	             <div class="col-md-10">
	                 <input type="text" class="col-md-10 col-lg-2 validate[maxSize[18]]"  id="propertyType" name="propertyType"   value="${proSeaulUp.propertyType}"  />
			...
			<div class="form-group">
	             ...
	             <div class="col-md-10">
	                 <input type="text" class="col-md-2 col-lg-2 validate[maxSize[18]]"  id="recordNum" name="recordNum"   value="${proSeaulUp.recordNum}"  />
	                 <span class="col-md-10 col-lg-10" style="line-height:28px;"></span>
	             </div>
			</div>
			<div class="form-group">
