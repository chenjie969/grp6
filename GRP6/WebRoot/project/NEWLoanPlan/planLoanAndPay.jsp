	...
	<div class="row">
		...
		<c:forEach items="${meetingDetailList}" var="meetingDetail">
					...
					<div class="widget-body">
						<div class="widget-body-inner" style="display: block;">
							<div class="widget-main no-padding">
								...
								<h5 style="line-height: 26px;" class="col-sm-6 no-margin-top">担保责任范围：<span class="grey">${meetingDetail.guarantyScope==""?"(空)":meetingDetail.guarantyScope}&nbsp;&nbsp;<fmt:formatNumber value='${meetingDetail.guarantyScale}' pattern='###,###.######'/>%</span></h5>
			...
			<div class="col-xs-12">
				<div class="widget-box transparent">
					<div class="widget-header widget-header-flat">
						<h4 class="smaller lighter orange">放款计划、还款计划与应收费用</h4>
						<div class="widget-toolbar" style="height:37px;">
							<a href="javascript:void(0)"  data-action="collapse" style="margin-top:10px;"><i class="icon-chevron-up"></i></a>
						</div>
						<c:if test="${urlParam.type == 'edit'}">
							<a href="javascript:void(0)" style="margin-right:10px;line-height:37px;display:block;text-decoration:none;"  class="pull-right btn_addLoanPlan" data-meetingDetailID="${meetingDetail.meetingDetail_ID }">
										...
										<c:forEach items="${meetingDetail.loanPlanList }" var="loanPlan" varStatus="loanPlanStatus">
											<div class="widget-box">
												<div class="widget-header">
													...
													<c:if test="${urlParam.type == 'edit'}">
														<div class="widget-toolbar action-buttons" style="height:37px;">
															<a href="javascript:void(0)" style="margin:10px 0 0 10px;"  title="删除" class="pull-right btn_deleteLoanPlan" data-loanPlanID="${loanPlan.loanPlan_ID }">
																<i class="icon-trash bigger-120 red" ></i>
															</a>
															<a href="javascript:void(0)" style="margin-top:10px;"  title="修改" class="pull-right btn_editLoanPlan" data-loanPlanID="${loanPlan.loanPlan_ID }">
												...
												<div class="widget-header">
													...
													<c:if test="${urlParam.type == 'edit'}">
														<div class="widget-toolbar" style="height:37px;">
															<a href="javascript:void(0)" style="margin-right:10px;line-height:37px;display:block;text-decoration:none;"  class="pull-right btn_autoAddPlanPay" data-loanPlanID="${loanPlan.loanPlan_ID }">
																<i class="icon-edit bigger-110 orange" ></i>
																<span class="no-text-shadow orange">自动生成</span>
															</a>
															<a href="javascript:void(0)" style="margin-right:10px;line-height:37px;display:block;text-decoration:none;"  class="pull-right btn_addPlanPay" data-loanPlanID="${loanPlan.loanPlan_ID }">
																<i class="icon-edit bigger-110 orange" ></i>
																<span class="no-text-shadow orange">添加还款计划</span>
															</a>
														</div>	
													</c:if>
												</div>
															...
															<c:otherwise>
																<table class="table table-striped table-bordered table-hover" style="border:1px solid #ddd;" id="table_planPay_${loanPlan.loanPlan_ID }">
																	...
																	<tbody>
																		...
																		<c:forEach items="${loanPlan.planPayList }" var="planPay">
																			<tr>
																				...
																				<c:if test="${urlParam.type == 'edit'}">
																					<td>
																						<button class="btn btn-xs btn-info btn_editPlanPay" href="javascript:void(0)" title="修改" data-planPayID="${planPay.planPay_ID }"><i class="icon-pencil bigger-120"></i></button>
																						<button class="btn btn-xs btn-danger btn_delPlanPay" href="javascript:void(0)" title="删除" data-planPayID="${planPay.planPay_ID }"><i class="icon-trash bigger-120"></i></button>
																					</td>
																				</c:if>
																			</tr>
												...
												<!-- 2017/10/23 放款/还款计划 与 担保收费 合并后 , 添加的原担保收费的div块 -->
												<div class="widget-header">
													...
													<c:if test="${urlParam.type == 'edit'}">
														<div class="widget-toolbar" style="height:37px;">
															<a href="javascript:void(0)" style="margin-right:10px;line-height:37px;display:block;text-decoration:none;"  class="pull-right btn_addCostMust" 
																...
																<i class="icon-edit bigger-110 orange" ></i>
																<span class="no-text-shadow orange">添加应收费用</span>
															</a>
														</div>	
													</c:if>
												</div>
														...
														<c:choose>
															...
															<c:otherwise>
																<table class="table table-striped table-bordered table-hover" style="border:1px solid #ddd;" id="table_planPay_${loanPlan.loanPlan_ID }">
																	...
																	<tbody>
																		<c:forEach items="${loanPlan.costMustList }" var="costMust">
																			<tr>
...
<div id="page_planLoanAndPay"></div>
<!-- 2017/10/23 放款/还款计划 与 担保收费 合并后 , 添加的原担保收费的div块 -->
<div id="page_costMust"></div>

<%@ include file="/common_del.jsp" %>
<%@ include file="/common_confirm.jsp" %>
<%@ include file="/project/NEWLoanPlan/addMustCostConfirm.jsp" %>


<script src="<%=path %>/project/NEWLoanPlan/planLoanAndPay.js?v=<%=vardate%>"></script>
