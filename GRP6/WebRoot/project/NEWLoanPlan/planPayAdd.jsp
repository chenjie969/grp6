      ...
      <div class="modal-body">
		<form class="form-horizontal" role="form" id="form_planPayAdd">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" name="planPayMonth" class="col-sm-8 validate[required,custom[number],maxSize[5]]" id="addPlanPayMonth"/>
				</div>
			</div>
			<div class="form-group">
 			...
 			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" name="planPaySum" class="col-sm-8 validate[required,custom[number],maxSize[18]]" id="addPlanPaySum"/>
