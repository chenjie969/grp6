...
<div class="modal fade" id="delCreditApply" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">删除授信申请</h4>
      </div>
      <div class="modal-body">
      		<div class="alert bigger-110">
      			<i class="icon-warning-sign red bigger-130"></i>
				<span id="text_deleteWarning"></span>
			</div>
      </div>
