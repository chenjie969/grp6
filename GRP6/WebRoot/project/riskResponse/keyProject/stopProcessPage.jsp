    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		<form class="form-horizontal" role="form" id="stopProcess_form">
			 <input type="hidden" name="riskScheme_ID" class="riskScheme_ID" value="${riskScheme.riskScheme_ID}">
			...
			<div class="form-group ">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-2"><i class="icon-asterisk orange"></i> 终止日期： </label>
					<div class="col-sm-9">
	        ...
	        <div class="form-group ">
				   <label class="col-sm-3 control-label no-padding-right" for="form-field-1"><i class="icon-asterisk orange"></i>终止原因： </label>
		           <div class="col-sm-9">
