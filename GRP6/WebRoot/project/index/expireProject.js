...
//			{field:'checked',checkbox:true,align:'center',formatter: function (value, row, index) {return ;}},
	...
	function initProjectTalble(columns){
		...
		$('#project-table').bootstrapTable({
			...
			url: "/project/index/selectExpireProjectPageTables",//这个接口需要处理bootstrap table传递的固定参数
...
$(function () {
	 ...
	 * 办理
	 */
	$("#btn_checkPlan").click(function(){
		$.zjm_projectTracking.checkPlan();
	});
