...
//			{field:'projectCode',title:'项目编号',align:'center',formatter: function (value, row, index) {return row.projectCode;}},
			...
			{field:'payCapitalSum',title:'还款金额（万元）',align:'center',formatter: function (value, row, index) {return row.payCapitalSum;}},
			{field:'guarantySum',title:'项目余额（万元）',align:'center',formatter: function (value, row, index) {return row.guarantySum;}},
//			{field:'loadSum',title:'担保金额（万元）',align:'center',formatter: function (value, row, index) {return row.loadSum;}},
//			{field:'loadSum',title:'担保期限',align:'center',formatter: function (value, row, index) {return row.loadSum;}},
			...
			{field:'payDate',title:'实际还款日期',align:'center',formatter: function (value, row, index) {return tool.parseDate(row.payDate);}},
	...
	function initProjectTalble(columns){
		...
		$('#project-table').bootstrapTable({
			...
			queryParams: function(params) {
				$.extend(params,{"wheresql":" and YEAR(payDate) = YEAR(NOW()) AND MONTH(payDate) = MONTH(NOW()) "});
				return params;
