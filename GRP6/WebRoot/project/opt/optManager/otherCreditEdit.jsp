...
<style>
						...
						<form class="form-horizontal" role="form" id="form_baseTwo">
                           ...
                           <c:if test="${opt.clientTypeID eq '01' }">      
                            ...
                            <c:if test="${opt.clientTypeID ne '01' }">      
                              <div class="form-group col-sm-6">
                                  <label class="col-sm-4 control-label no-padding-right" for="form-input"><i class="icon-asterisk orange"></i>权属人： </label>
                                  <label style="line-height:29px;">${opt.personName }</label>
                              </div>
                              
                              <div class="form-group col-sm-6">
                                  <label class="col-sm-4 control-label no-padding-right clientType" for="form-input"><i class="icon-asterisk orange"></i>身份证号码：</label>
                                    		...
                                    		<div class="col-sm-6">
			                                    ...
			                                    <select class="col-sm-6 validate[required]" name="guaranteePatternID" id="guaranteePatternID">
				                                    ...
				                                    <c:forEach var="gList" items="${guaranteeList }">
				                                    	<option value="${gList.dicTypeID }" 
				                                    		<c:if test="${opt.guaranteePatternID eq gList.dicTypeID }"> selected='selected'</c:if>
				                                    	>${gList.dicTypeName }</option>
				                                    </c:forEach>	
			                                    </select>
			                                  </div>  
	                                    </div>
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" id="form-field-1" name="guaranteeSum" value="<fmt:formatNumber value="${opt.guaranteeSum }" pattern="###.######"/>" class="col-sm-3 validate[custom[number],maxSize[18]]" />
	...
	<script src="<%=path%>/project/opt/optManager/otherCreditEdit.js?v=<%=vardate%>"></script>
