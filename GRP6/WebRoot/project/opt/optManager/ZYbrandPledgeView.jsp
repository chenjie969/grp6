...
<style>
						...
						<form class="form-horizontal" role="form" id="form_baseTwo">
                          ...
                          <div class="col-sm-offset-1 col-sm-10">
							 ...
							 <c:if test="${opt.clientTypeID ne '01' }">   	
                            	...
                            	<h5 class="col-sm-6" style="line-height:26px;">商标注册号：<span class="grey">${opt.brandCode }</span></h5>
                            	<h5 class="col-sm-6" style="line-height:26px;">核定使用商品：<span class="grey">${opt.useCommodity }</span></h5>
                            	<h5 class="col-sm-6" style="line-height:26px;">注册人：<span class="grey">${opt.landOwnerName }</span></h5>
                            	<h5 class="col-sm-6" style="line-height:26px;">注册有效期限：<span class="grey">
                            		<fmt:formatDate value="${opt.insuranceBeginDate }" pattern="yyyy-MM-dd"/>~<fmt:formatDate value="${opt.insuranceEndDate }" pattern="yyyy-MM-dd"/></span></h5>
                            	
                            	<h5 class="col-sm-6" style="line-height:26px;">注册地址：<span class="grey">${opt.adderss }</span></h5>
	...
	<script src="<%=path%>/project/opt/optManager/ZYbrandPledgeView.js?v=<%=vardate%>"></script>
