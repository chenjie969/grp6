...
<style>
                    ...
                    <div class="col-sm-offset-1 col-sm-10">
                          ...
                          <div id="isHaveOtherDIV"> 	
                        	...
                        	<div  id="isProxyDIV">
                        		 ...
                        		 <h5 class="col-sm-12" style="line-height:26px;">抵押物品名称：<span class="grey">${opt.optName }</span></h5>
                        		 <h5 class="col-sm-12" style="line-height:26px;">坐落：<span class="grey">${opt.houseAddress }</span></h5>
                        		 <h5 class="col-sm-6" style="line-height:26px;">房屋所有权证号：<span class="grey">${opt.certificateNum }</span></h5>
                        		 <h5 class="col-sm-6" style="line-height:26px;">房产面积：<span class="grey">
                        		 	<fmt:formatNumber value="${opt.houseArea }" pattern="###,###.##"/>平方米</span></h5>
                        		 	
                        		 <%-- <h5 class="col-sm-6" style="line-height:26px;">抵押房产部位：<span class="grey">${opt.pledgePart }</span></h5> --%><!-- 融投不需要 rd_xujy 20180321 -->

                        		  <h5 class="col-sm-6" style="line-height:26px;">抵押房产面积：<span class="grey">
                        		 	<fmt:formatNumber value="${opt.havingArea }" pattern="###,###.##"/>平方米</span></h5>	
                              
                              
							
							
                              	 <h5 class="col-sm-6" style="line-height:26px;">抵押房产评估价值：<span class="grey">
                        		 	<fmt:formatNumber value="${opt.assessValue }" pattern="###,###.######"/>万元</span></h5>
                        		 	
                        		 <h5 class="col-sm-6" style="line-height:26px;">我公司抵押权顺位：<span id="sortNum" class="grey">${opt.sortNum }</span></h5>
                        		
                        		 <h5 class="col-sm-6 prefixOne" style="line-height:26px;">第一位前置抵押人：<span class="grey">${opt.preposePledgeeOne }</span></h5>
                        		 <h5 class="col-sm-6 prefixOne" style="line-height:26px;">第一位前置抵押价值：<span class="grey">
                        		 <fmt:formatNumber value="${opt.preposeOneSum }" pattern="###,###.######"/>万元</span></h5>
                        		 
                        		 <h5 class="col-sm-6 prefixTwo" style="line-height:26px;">第二位前置抵押人：<span class="grey">${opt.preposePledgeeTwo }</span></h5>
                        		 <h5 class="col-sm-6 prefixTwo" style="line-height:26px;">第二位前置抵押价值：<span class="grey">
                        		  <fmt:formatNumber value="${opt.preposeTwoSum }" pattern="###,###.######"/>万元</span></h5>
                        		
                        		 <h5 class="col-sm-6 prefixThree" style="line-height:26px;">第三位前置抵押人：<span class="grey">${opt.preposePledgeeThree }</span></h5>
                        		 <h5 class="col-sm-6 prefixThree" style="line-height:26px;">第三位前置抵押价值：<span class="grey">
                        		  <fmt:formatNumber value="${opt.preposeThreeSum }" pattern="###,###.######"/>万元</span></h5>
                        		 
                        		 <h5 class="col-sm-12 prefixOne" style="line-height:26px;">我公司抵押顺位实际余值：<span class="grey">
                        		 	<fmt:formatNumber value="${opt.actualValue }" pattern="###,###.######"/>万元</span></h5>
                        		 	
                        		 <h5 class="col-sm-6" style="line-height:26px;">抵押率：<span class="grey">
                        		 	<fmt:formatNumber value="${opt.coverageRatio }" pattern="###.##"/>%</span></h5>
                        		 	
                        		 <h5 class="col-sm-6" style="line-height:26px;">抵押土地抵押价值：<span class="grey">
	...
	<script src="<%=path%>/project/opt/optManager/DYhouseGuarantyView.js?v=<%=vardate%>"></script>
