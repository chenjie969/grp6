				...
				<div id="divTwo">	<!-- divTwo 开始-->
					...
					<c:if test="${opt.relieveFlag eq '01' || opt.relieveFlag eq '02'}">
						...
						<form class="form-horizontal" role="form" id="form_baseTwo">
                                  ...
                                  <input type="hidden"  id="depositTypeId" name="depositTypeId" value="${opt.depositTypeId }">
                          <div class="col-sm-offset-1 col-sm-10">
							 ...
							 <c:if test="${opt.clientTypeID ne '01' }">   	
							  ...
							  <h5 class="col-sm-12" style="line-height:26px;">申请金额：<span class="grey">
								<fmt:formatNumber value="2000" pattern="####.######"/>万元</span></h5>
								
							<div class="col-sm-12">
                              <h5 class="col-sm-6" style="line-height:26px;">保证金比例：<span class="grey">
                              	<fmt:formatNumber value="${opt.guaranteeScale }" pattern="###.##"/>%</span></h5>
                              <h5 class="col-sm-6" style="line-height:26px;">保证金类型：<span class="grey" id="dic_depositTypeName"></span></h5>
							</div>
                              
                              <h5 class="col-sm-12" style="line-height:26px;">保证金金额：<span class="grey">
...
<%@ include file="/project/opt/optManager/common_optView.jsp" %>
	<script src="<%=path%>/project/opt/optManager/pledgeMoenyCreditView.js?v=<%=vardate%>"></script>
