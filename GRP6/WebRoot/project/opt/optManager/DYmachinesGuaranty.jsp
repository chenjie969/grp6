...
<style>
                   ...
                   <!--  <form class="form-horizontal" role="form" id="form_baseOne"> -->
                        ...
                        <div id="isUseOtherDIV">
                        	 ...
                        	 <div class="col-sm-6 form-group hidden-xs " style="height: 30px"></div>
                              ...
                              <div class="form-group col-sm-6">
                                  <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <i class="icon-asterisk orange"></i>设备编号： </label>
                                  <div class="col-sm-8">
                                      <input type="text" id="machinesNumber" name="machinesNumber" class="col-sm-6 validate[required,maxSize[50]]" />
                                  </div>
                              </div>
                              ...
                              <div class="form-group col-sm-6">
                                  <label class="col-sm-4 control-label no-padding-right" for="form-input"> 是否已上保险： </label>
                                      <div class="radio">
                                          <label style="margin-top:-10px;">
                                              <input type="radio" name="isInsurance" class="ace" checked="checked" value="1">
                                              <span class="lbl">是</span>
                                          </label>
                                          <label style="margin-top:-10px;">
                                              <input type="radio" name="isInsurance" class="ace" value="0">
                                              <span class="lbl">否</span>
                                          </label>
                                      </div>
                               </div>
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-10">
	                                  <div class="row">
	                                  	<div class="col-sm-12">
                                  			<textarea class="col-sm-5 limited validate[maxSize[2000]]" id="otherDesc" name="otherDesc" rows="5"></textarea>
                                  		</div>
	                                  </div>
	...
	<script src="<%=path%>/project/opt/optManager/DYmachinesGuaranty.js?v=<%=vardate%>"></script>
