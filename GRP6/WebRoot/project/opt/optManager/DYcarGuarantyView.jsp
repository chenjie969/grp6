					...
					<c:if test="${opt.relieveFlag ne '01' && opt.relieveFlag ne '02'}">
						...
						<form class="form-horizontal" role="form" id="form_baseTwo">
                          ...
                          <div id="isHaveOtherDIV"> 	
                              ...
                              <h5 class="col-sm-6" style="line-height:26px;">机动车品牌及型号：<span class="grey">${opt.carBrandAndType }</span></h5>
                              <h5 class="col-sm-6" style="line-height:26px;">机动车购买日期：<span class="grey">
                              <fmt:formatDate value="${opt.carBuyDate }" pattern="yyyy-MM-dd"/>	</span></h5>
                              <h5 class="col-sm-6" style="line-height:26px;">牌照号码：<span class="grey">${opt.carCode }</span></h5>
                              <h5 class="col-sm-6" style="line-height:26px;">发动机号：<span class="grey">${opt.carEngineCode }</span></h5>
                              <h5 class="col-sm-6" style="line-height:26px;">车架号：<span class="grey">${opt.carFrame }</span></h5>
                              <h5 class="col-sm-6" style="line-height:26px;">保管方式：<span class="grey">${opt.keepType }</span></h5>
                              ...
                              <h5 class="col-sm-6" style="line-height:26px;">保单起止日期：<span class="grey">
                               ...
                               <h5 class="col-sm-6" style="line-height:26px;">车主是否本地籍：<span class="grey">
                              	<c:if test="${opt.isLocal eq 1 }">是</c:if>
                              	<c:if test="${opt.isLocal ne 1 }">否</c:if>
                              </span></h5>
                              
                              <h5 class="col-sm-12" style="line-height:26px;">交管局最新违章：<span class="grey">${opt.trafficViolation }</span></h5>
...
<%@ include file="/project/opt/optManager/common_optView.jsp" %>
		<script src="<%=path%>/project/opt/optManager/DYcarGuarantyView.js?v=<%=vardate%>"></script>
