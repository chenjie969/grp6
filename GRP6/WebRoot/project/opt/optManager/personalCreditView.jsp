...
<style>
					...
					<c:if test="${opt.relieveFlag ne '01' && opt.relieveFlag ne '02'}">
						...
						<form class="form-horizontal" role="form" id="form_baseTwo">
                            ...
                            <div class="col-sm-offset-1 col-sm-10">
                               ...
                               <h5 class="col-sm-6" style="line-height:26px;">手机号：<span class="grey">${opt.otherPersonPhone }</span></h5>
                               <h5 class="col-sm-12" style="line-height:26px;">现住地址：<span class="grey">${opt.otherPersonAddress }</span></h5>
                                  
                              
								    <h5 class="col-sm-12" style="line-height:26px;">是否已婚：<span id="isMarried" class="grey">
								    	<c:if test="${opt.isMarried == 1 }">是</c:if>
								    	<c:if test="${opt.isMarried == 0 }">否</c:if>
								    </span></h5>
                              
		                          <div id="isMarriedDIV">
									    <h5 class="col-sm-6" style="line-height:26px;">配偶姓名：<span class="grey">${opt.spouseName }</span></h5>
									    <h5 class="col-sm-6" style="line-height:26px;">配偶身份证号码：<span class="grey">${opt.spouseCode }</span></h5>
		                          </div>
                              
                              
							 
							    <h5 class="col-sm-12" style="line-height:26px;">担保方式：<span class="grey">${opt.guaranteePattern }</span></h5>
							    ...
							    <h5 class="col-sm-12" style="line-height:26px;">资产清单描述：<span class="grey">${opt.otherDesc }</span></h5>
	...
	<script src="<%=path%>/project/opt/optManager/personalCreditView.js?v=<%=vardate%>"></script>
