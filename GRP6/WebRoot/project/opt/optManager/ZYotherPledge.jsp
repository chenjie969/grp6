...
<style>
				...
				<div id="divTwo">	<!-- divTwo 开始-->
					...
					<form class="form-horizontal" role="form" id="form_baseTwo">
                              ...
                              <div class="form-group col-sm-6">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" id="coverageRatio" placeholder="" name="coverageRatio" class="col-sm-4 validate[required,custom[number],max[100],maxSize[18]]" />
	...
	<script src="<%=path%>/project/opt/optManager/ZYotherPledge.js?v=<%=vardate%>"></script>
