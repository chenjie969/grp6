...
<style>
                           ...
                           <c:if test="${opt.clientTypeID eq '01' }">      
                            ...
                            <c:if test="${opt.clientTypeID ne '01' }">      
                              ...
                              <div class="form-group col-sm-6">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" id="brandCode" name="brandCode" class="col-sm-6 validate[required,maxSize[50]]" value="${opt.brandCode }"/>
                                  </div>
                              </div>
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-10">
                                      <input type="text" id="useCommodity" name="useCommodity" class="col-sm-5 validate[maxSize[50]]" value="${opt.useCommodity }"/>
                                  </div>
                              </div>
                              ...
                              <div class="form-group col-sm-6">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" id="landOwnerName" name="landOwnerName" class="col-sm-6 validate[maxSize[50]]" value="${opt.landOwnerName }"/>
                                  </div>
                              </div>
							...
							<div class="form-group col-sm-6">
							 ...
							 <div class="form-group">
                                  ...
                                  <div class="col-sm-10">
                                      <input type="text" id="adderss" name="adderss" class="col-sm-5 validate[maxSize[50]]" value="${opt.adderss }"/>
                                  </div>
                              </div>
	...
	<script src="<%=path%>/project/opt/optManager/ZYbrandPledgeEdit.js?v=<%=vardate%>"></script>
