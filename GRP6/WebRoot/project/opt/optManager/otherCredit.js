...
(function($,z){
	$.zjm_DYlandGuaranty={
		...
		guarantySelect:guarantySelect // 反担保方式 -- 赋默认值
	};
	 ...
	 * 反担保方式 -- 赋默认值
	 */
	function guarantySelect(val){
		$("input[name='guaranteePattern']").val(val);
	}
...
$(function(){
	 ...
	 * 反担保方式 -- 赋默认值
	 */
	$("#guaranteePatternID").change(function(){
		var _val =$('#guaranteePatternID option:selected').text();
		$.zjm_DYlandGuaranty.guarantySelect(_val);
	})
})