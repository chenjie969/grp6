                    ...
                    <div class="col-sm-offset-1 col-sm-10">
                          ...
                          <div id="isHaveOtherDIV"> 	
                        	...
                        	<div  id="isProxyDIV">
                        		 ...
                        		 <h5 class="col-sm-6" style="line-height:26px;">土地证号：<span class="grey">${opt.landCode }</span></h5>
                        		<%--  <h5 class="col-sm-6" style="line-height:26px;">土地来源：<span class="grey">${opt.landSource }</span></h5> --%>
                        		 <h5 class="col-sm-6" style="line-height:26px;">土地面积：<span class="grey">${opt.landArea }</span></h5>
                        		 <h5 class="col-sm-6" style="line-height:26px;">抵押土地面积：<span class="grey">${opt.pledgeLandArea }</span></h5>
                        		 <h5 class="col-sm-6" style="line-height:26px;">抵押土地评估价值：<span class="grey">
                        		 ...
                        		 <h5 class="col-sm-6 prefixOne" style="line-height:26px;">我公司抵押顺位实际余值：<span class="grey">
                        		 ...
                        		 <h5 class="col-sm-12" style="line-height:26px;">抵押土地抵押价值：<span class="grey">
...
<%@ include file="/project/opt/optManager/common_optView.jsp" %>
	<script src="<%=path%>/project/opt/optManager/DYlandGuarantyView.js?v=<%=vardate%>"></script>
