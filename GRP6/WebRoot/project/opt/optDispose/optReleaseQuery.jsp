...
<div class="modal fade" id="optReleaseQuery" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	 <form class="form-horizontal row" role="form" id="form_optRelease">
			...
			<div class="form-group">
			   	...
			   	<div class="col-sm-6">
			        <div class="col-sm-12 input-group selectCreateUser"> <%-- 取值： 解除操作经办人 --%>
						<input  type="text"  class="form-control" autoField="freeUserID"   id="selectCreateUser"  
							value="" dataValue="" name="freeUserName" readonly="readonly"/>
			...
			<div class="form-group">
		   	    <label class="col-sm-3 control-label no-padding-right" for="form-input">解除日期： </label>
		        <div class="col-sm-9">
					<div class="row">
						<div class="col-sm-4 no-padding-right">
							<div class="input-group">
								<input class="form-control date-picker validate[custom[date]]" type="text"  data-date-format="yyyy-mm-dd" name="freeBeginDate" />
								<span class="input-group-addon">
						...
						<div class="col-sm-4 no-padding-left">
							<div class="input-group">
								<input class="form-control date-picker validate[custom[date]]" type="text"  data-date-format="yyyy-mm-dd" name="freeEndDate" />
								<span class="input-group-addon">
									<i class="icon-calendar bigger-110"></i>
								</span>
							</div>
