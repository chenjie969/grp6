...
<style type="text/css">
	...
	.table_chargeInfo tr th,.table_chargeInfo tr td{		
		border:1px solid #ddd;
		text-align: center;
		vertical-align:middle
	};
</style>
<div class="modal fade" id="mustChargeAdd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title">新增应收费用</h4>
			</div>
				...
				<form class="form-horizontal row" role="form" id="form_addMustCost">
					...
					<div class="form-group">
						...
						<div class="col-sm-offset-1 col-sm-10">
							<table class="table table-hover table-striped table_chargeInfo">
					 			<thead>
									<tr>
										<th><i class="icon-asterisk orange"></i>费用类别</th>
										<th>费率 </th>
										<th><i class="icon-asterisk orange"></i>应收金额（元）</th>
...
<script src="<%=path %>/project/finance/projectCost/mustChargeAdd.js?v=<%=vardate%>"></script>	
