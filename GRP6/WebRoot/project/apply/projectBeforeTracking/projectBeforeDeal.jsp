...
<%@ include file="/project/apply/projectBeforeTracking/mainProduct.jsp"%>
		<%-- <div class="tabbable">
			...
			<div class="tab-content">
                ...
                <div id="picture" class="tab-pane ">
					<%@ include file="/gworkFlow/trackingWorkFlow.jsp"%>
				</div>
			</div><!-- /.col-sm-10 -->
		</div> --%><!-- /.row -->
								...
								<div class="widget-main">
                                    <div id="fuelux-wizard" class="row-fluid" data-target="#step-container">
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="hidden" id="apply_ID" class="apply_ID"  value="${apply.apply_ID}"><!-- -->
...
<script src="<%=path %>/project/apply/projectBeforeTracking/projectBeforeDeal.js?v=<%=vardate%>"></script>
