...
<%@ include file="/common_foot.jsp" %>
	...
	<div class="page-content">
		<div class="row" style="display:block" id="personClientPage">
			<div class="col-xs-12">
				<div class="page-header">
					...
					<button class="btn btn-sm btn-info" id="btn_projectTypeSelect" >新增历史项目</button>
					...
					<button class="btn btn-sm btn-info" id="btn_transfer" >项目移交</button>
					<button class="btn btn-sm btn-info" id="btn_projectCreditor" >债权转让</button>
					<button class="btn btn-sm btn-info" id="btn_costReturn" >退回保费</button>
					<button class="btn btn-sm btn-info" id="btn_hightSelect" >高级查询</button>
					<button class="btn btn-sm btn-info" id="btn_isUrgeLetter" >是否有催告函</button>
		...
		<div id="projectTypeSelect_page"></div>
		<div id="projectAfter_page"></div>
	</div><!-- /.page-content -->
	<script type="text/javascript" src="<%=path %>/project/apply/projectAfterTrackingWD.js?v=<%=vardate%>"></script>
	<%@ include file="/common_message.jsp"%>
	<%@ include file="/project/apply/projectAfterEdit.jsp"%>
