      ...
      <div class="row">
		<div class="col-xs-12">
			...
			<div class="col-sm-12">
                ...
                <h5 class="col-sm-6">业务品种：<span class="grey">
                	<c:choose>
                ...
                <h5 class="col-sm-6">合同起始日期：<span class="grey">
                	<c:choose>
                ...
                <h5 class="col-sm-6">合同到期日期：<span class="grey">
                	<c:choose>
...
<script src="<%=path %>/project/apply/dutyRemove/reimAndCompenDetial.js?v=<%=vardate%>"></script> 
