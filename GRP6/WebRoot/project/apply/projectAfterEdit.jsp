           ...
           <!-- <div class="form-group col-sm-6">
           	...
           	<div class="form-group col-sm-6">
                  <label class="col-sm-4 control-label no-padding-right">
           		<c:if test="${project.busiClass =='01'}"><i class="icon-asterisk orange"></i></c:if>承保机构： </label>
                  <label class="col-sm-8 grey">
           	...
           	<div class="form-group col-sm-6">
                  <label class="col-sm-4 control-label no-padding-right"><i class="icon-asterisk orange"></i>承保地区： </label>
                  <label class="col-sm-8 grey">
