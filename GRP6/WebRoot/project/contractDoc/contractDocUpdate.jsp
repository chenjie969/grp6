...
<div class="modal fade" id="updateContractDoc" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	 <form class="form-horizontal row" role="form" id="updateContractDoc_form">
      		 <input type="hidden" name="contractDoc_ID"  value="${contractdoc.contractDoc_ID }"/>
			<input type="hidden" name="apply_ID"  value="${contractdoc.apply_ID }"/>	
				
			<div class="form-group">
				<label class="col-sm-4 control-label no-padding-right" for="form-input"><i class="icon-asterisk orange"></i>合同编号： </label>
				<div class="col-sm-8">
					<input type="text" class="col-sm-8 validate[required]" name="contractCode" id="contractCode" value="${contractdoc.contractCode }"/>
				</div>
			</div>	
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
						<input type="text" class="col-sm-8 validate[required]" value="${contractdoc.contractName }" name="contractName" id="contractName"/>
				</div>
			</div>
			...
			<div class="form-group">
						...
						<div class="col-sm-8">
							...
							<select class="col-xs-8 validate[required] contractTypeID" id="contractTypeID" name="contractTypeID">
								<c:forEach var="dicType" items="${dicTypeList}"
									varStatus="status">
									<option value="${dicType.dicTypeID}" <c:if test="${contractdoc.contractTypeID eq dicType.dicTypeID}"> selected="selected"</c:if> >${dicType.dicTypeName}</option>
								</c:forEach>
							</select>
						</div>
					</div>
						...
						<div class="col-sm-8">
							<div class="input-group col-sm-8">
								<input class="form-control date-picker validate[required,custom[date]]"
									type="text" id="contractBeginDate" value="<fmt:formatDate value="${contractdoc.contractBeginDate }" pattern="yyyy-MM-dd"/>" data-date-format="yyyy-mm-dd" name="contractBeginDate" /> 
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<div class="input-group col-sm-8">
								<input class="form-control date-picker validate[required,custom[date]]"
									type="text" id="contractEndDate" value="<fmt:formatDate value="${contractdoc.contractEndDate }" pattern="yyyy-MM-dd"/>" data-date-format="yyyy-mm-dd" name="contractEndDate" /> 
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<textarea class="col-xs-8 validate[maxSize[100]]" name="remark"
								rows="5">${contractdoc.remark }</textarea>
