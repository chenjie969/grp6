    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		<form class="form-horizontal" role="form" id="form_planPayEdit">
			<input type="hidden" name="applyDetailID" value="${planPay.applyDetail_ID }">
 			...
 			<div class="form-group">
				...
				<label class="col-sm-8" for="form-field-1">${planPay.bankName }</label>
			</div>
			
			<div class="form-group">
				<label class="col-sm-4 control-label no-padding-right" for="form-field-1"><i class="icon-asterisk orange"></i>业务品种： </label>
				<label class="col-sm-8" for="form-field-1">${planPay.busiTypeName }</label>
			</div>
 			...
 			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" name="planPaySum" class="col-sm-8 validate[required,custom[number],maxSize[18]]" value="<fmt:formatNumber value="${planPay.planPaySum }" pattern="###.######"/>" />
