...
<div class="modal fade" id="planPayAdd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false" style="z-index:9999">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">添加还款计划</h4>
      </div>
      <div class="modal-body">
		<form class="form-horizontal" role="form" id="form_planPayAdd">
			<input type="hidden" name="apply_ID" value="${applyID }"/>
		
      		<div class="form-group">
		   	    <label class="col-sm-4 control-label no-padding-right" for="form-input"><i class="icon-asterisk orange"></i>选择产品： </label>
		        <div class="col-sm-8">
					<div class="row">
						<div class="col-sm-10">
							<select class="col-sm-12 validate[required]"  name="applyDetail_ID">
								<c:forEach	items="${applyDetailList }" var="applyDetail">
									<option value="${applyDetail.applyDetail_ID }">${applyDetail.bankName }--${applyDetail.busiTypeName }</option>
								</c:forEach>
							</select>
						</div>	
					</div>
 			...
 			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" name="planPaySum" class="col-sm-8 validate[required,custom[number],maxSize[18]]"/>
