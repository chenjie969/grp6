...
<div class="modal fade" id="addProDelay" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog  modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	 <form class="form-horizontal row" role="form" id="addProDelay_form">
				<input type="hidden" id="projectID" name="project_ID" value="${project.project_ID }">	
				<input type="hidden" name="applyID" value="${project.apply_ID }">	
				<div class="form-group col-sm-6">
					<label class="col-sm-4 control-label no-padding-right" for="form-field-1"><i class="icon-asterisk orange"></i>展期金额： </label>
					<div class="col-sm-8">
					    <div class="row">
						    <div class="col-sm-10">
								<input type="text" id="delaySum_add" name="delaySum" class="col-sm-8 validate[required]"/>
				...
				<div class="form-group col-sm-6">
					...
					<div class="col-sm-8">
						<div class="row">
								<input type="number" name="delayMonth" class="col-xs-3 col-sm-3 validate[required,custom[integer],maxSize[18]]" />
								<span class="midden col-sm-3 " style="line-height:28px;">个月</span>
								<input type="number" name="delayDay" class="col-xs-3 col-sm-3 validate[custom[integer],maxSize[30]]"/>
						...
						<div class="row">
							<div class="col-sm-10">
								<div class="input-group">
									<input class="form-control date-picker validate[required,custom[date]]" type="text" id="delayBeginDate" data-date-format="yyyy-mm-dd" name="delayBeginDate"/>
				...
				<div class="form-group col-sm-6">
			        ...
			        <div class="col-sm-8">
						<div class="row">
							<div class="col-sm-10">
								<div class="input-group">
									<input class="form-control date-picker validate[required,custom[date]]" type="text" id="delayEndDate" data-date-format="yyyy-mm-dd" name="delayEndDate"/>
				...
				<div class="form-group col-sm-6">
					...
					<div class="col-sm-8">
					    <div class="row">
						    <div class="col-sm-10">
								<input type="text" name="delayRate" class="col-sm-8"/>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
		                <button class="btn btn-sm btn-info" type="button" name="button" id="${project.project_ID }" onclick="$.zjm_loanAttachment.filesUpdate(this.id)">
		                    	上传</button>
