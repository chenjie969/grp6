...
<div class="modal fade" id="addCostMust" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">添加应收</h4>
      </div>
      <div class="modal-body">
      		<form class="form-horizontal row" role="form" id="addCostMust_form">
				...
				<div class="form-group ">
					...
					<div class="col-sm-9">
						<input type="text" name="costRate" onkeyup="calculationFee(this.value);" class="col-sm-4 validate[required] costRate" /> 
					</div>
				</div>
				...
				<div class="form-group ">
					...
					<div class="col-sm-9">
						<input type="text" name="mustCostSum" id="mustCostSum" readonly="readonly" class="col-sm-4 validate[required] getMoney" /> 
				...
				<div class="form-group">
			        ...
			        <div class="col-sm-9">
						<div class="input-group col-sm-8">
							<input class="form-control  date-picker mustCostDate validate[custom[date]]" type="text" data-date-format="yyyy-mm-dd" name="mustCostDate"/>
