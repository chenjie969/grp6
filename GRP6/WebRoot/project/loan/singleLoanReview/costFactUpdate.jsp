...
<div class="modal fade" id="updateCostFact" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">修改实收</h4>
      </div>
      <div class="modal-body">
      		<form class="form-horizontal row" role="form" id="updateCostFact_form">
					...
					<div class="col-sm-9">
						...
						<select class="col-sm-4 validate[required] costTypeID" id="costTypeID" name="costTypeID">
							<c:forEach var="costType" items="${costTypeList}" varStatus="status">
								<option <c:if test="${costFact.costTypeID eq costType.dicTypeID}">selected="selected"</c:if> value="${costType.dicTypeID}">${costType.dicTypeName}</option>
							</c:forEach>
						</select>
					</div> 
				...
				<div class="form-group ">
					...
					<div class="col-sm-9">
						<input type="text" name="costRate" value="${costFact.costRate }" class="col-sm-4 validate[required] costRate" onkeyup="calculationFee(this.value);"/> 
					</div>
				</div>
				...
				<div class="form-group ">
					...
					<div class="col-sm-9">
						<input type="text" value="${costFact.factCostSum }" readonly="readonly" name="factCostSum" id="factCostSum" class="col-sm-4 validate[required] getMoney" /> 
	 			...
	 			<div class="form-group">
			        ...
			        <div class="col-sm-9">
						<div class="input-group col-sm-8">
							<input value="<fmt:formatDate value="${costFact.factCostDate}" pattern="yyyy-MM-dd"/>" class="form-control  date-picker factCostDate validate[required,custom[date]]" type="text" data-date-format="yyyy-mm-dd" name="factCostDate"/>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<textarea class="col-xs-10 col-sm-8 validate[maxSize[100]]" name="remark"
								rows="5">${costFact.remark }</textarea>
