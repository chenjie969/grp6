...
<div class="page-content">
	<div class="row">
		<div class="col-xs-12">
			...
			<form class="form-horizontal row" role="form" id="finishSave_form">
				<input type="hidden" id="apply_ID" name="applyId" value="${finish.applyId }">
				<input type="hidden" id="project_ID" name="projectId" value="${finish.projectId }">
				...
				<table class="table table-bordered table-strip">
					...
					<%-- <c:if test="${!empty finish.margin }"> --%>
						<tr>
							...
							<td class="twoLocation"><input type="text" name="margin" value="${empty finish.margin? 0: finish.margin}">&nbsp;&nbsp;万元</td>
							
							<td class="oneLocation" >保证金用途</td>
							<td class="twoLocation"><textarea style="width:100%" name="remark">${empty finish.remark? '': finish.remark}</textarea>
							</td>
						</tr>
					<%-- </c:if> --%>
					
					<tr  title="请上传《解除保证责任通知书》、还款凭证复印件">
			...
			<div class="col-sm-12 clearfix form-actions">
				<div class="col-md-offset-5 col-md-7">
					<button class="btn btn_finishSave" type="button"><i class="icon-save bigger-110 "></i>保存</button>
