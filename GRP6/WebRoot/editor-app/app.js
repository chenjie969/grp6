            ...
            function fetchModel(modelId) {
              ...
              //***********************mashuo add begin 20170804   获取 人员  角色 任务事项 json数据
            	...
            	$http({method: 'POST', url: dicTaskurl}).success(function (data, status, headers, config) {
            		$rootScope.formItem=data.obj;
            	});
            	
            	
            	//***********************mashuo add end 20170804       获取 人员  角色 任务事项 json数据
