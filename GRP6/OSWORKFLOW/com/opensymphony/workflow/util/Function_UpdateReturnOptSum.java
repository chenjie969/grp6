 ...
 */
@Component
public class Function_UpdateReturnOptSum  implements FunctionProvider{
	...
	public void execute(Map transientVars, Map args, PropertySet ps) throws WorkflowException {
		...
		OptGuarantyService optGuarantyService = (OptGuarantyService) SpringContextUtil.getBean("optGuarantyService");
		String optWheresql = " and optGuaranty_ID = \'"+instance.getBusinessId()+"\'";
		Pro_optGuaranty optGuaranty = optGuarantyService.selectOneOptGuarantyInfo(optWheresql);
	}
