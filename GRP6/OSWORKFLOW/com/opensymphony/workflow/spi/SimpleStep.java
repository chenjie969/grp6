...
public class SimpleStep implements Step, Serializable {
    ...
    //zhongzk fixed 2012.04.22，增加步骤名称
    ...
    public SimpleStep(long id, long entryId, int stepId,String stepName, int actionId, String owner, Date startDate, Date dueDate, Date finishDate, String status, long[] previousStepIds, String caller) {
        this.id = id;
    ...
    public boolean equals(Object obj)
    {
      ...
      SimpleStep step = (SimpleStep)obj;

      return (step.getStepId() == this.stepId) && (step.getOwner().trim().equals(this.owner.trim()));
    }
