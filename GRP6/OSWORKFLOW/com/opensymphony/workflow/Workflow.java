...
public interface Workflow {
    ...
    */
     ...
     */
    //�޸�ǰ:public void doAction(long id, int actionId, Map inputs) throws InvalidInputException, WorkflowException;
    //�޸ĺ�:zhongzk
    public void doAction(long id, int actionId, Map inputs,Map<String,String> rolemap) throws InvalidInputException, WorkflowException;
    ...
    */
    ...
    /**
     * @author:zhongzk 2012.04.22 ���Ӵ˷�����ȡ��ĳһ���û��ĵ�ǰĳһ�������ϵ�������Ч����
     */
