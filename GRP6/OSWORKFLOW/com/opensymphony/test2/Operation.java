...
public class Operation {
	...
	public boolean conversion(String expression,Double a,Double b) {

		boolean r=false;
		String rep2 = "";
		if(null==b){
			rep2 = expression.replaceAll("a", a+"");
		}else{
			String rep1 = expression.replaceAll("a", a+"");
			rep2 = rep1.replaceAll("b", b+"");
		}
